...
void
rap_localtime(time_t s, rap_tm_t *tm)
{
#if (RAP_HAVE_LOCALTIME_R)
...
void
rap_libc_localtime(time_t s, struct tm *tm)
{
#if (RAP_HAVE_LOCALTIME_R)
    (void) localtime_r(&s, tm);
...
void
rap_libc_gmtime(time_t s, struct tm *tm)
{
#if (RAP_HAVE_LOCALTIME_R)
    (void) gmtime_r(&s, tm);
