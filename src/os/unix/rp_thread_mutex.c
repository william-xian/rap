...
rp_int_t
rp_thread_mutex_create(rp_thread_mutex_t *mtx, rp_log_t *log)
{
    rp_err_t            err;
...
rp_int_t
rp_thread_mutex_destroy(rp_thread_mutex_t *mtx, rp_log_t *log)
{
    rp_err_t  err;
...
rp_int_t
rp_thread_mutex_lock(rp_thread_mutex_t *mtx, rp_log_t *log)
{
    rp_err_t  err;
    ...
    rp_log_error(RP_LOG_ALERT, log, err, "pthread_mutex_lock() failed");
...
rp_int_t
rp_thread_mutex_unlock(rp_thread_mutex_t *mtx, rp_log_t *log)
{
    rp_err_t  err;
    ...
    rp_log_error(RP_LOG_ALERT, log, err, "pthread_mutex_unlock() failed");
