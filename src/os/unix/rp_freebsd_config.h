...
#ifndef _RP_FREEBSD_CONFIG_H_INCLUDED_
#define _RP_FREEBSD_CONFIG_H_INCLUDED_
...
#define RP_LISTEN_BACKLOG        -1


#ifdef __DragonFly__
#define RP_KEEPALIVE_FACTOR      1000
#endif
...
#endif /* _RP_FREEBSD_CONFIG_H_INCLUDED_ */
