...
rap_int_t
rap_thread_mutex_create(rap_thread_mutex_t *mtx, rap_log_t *log)
{
    rap_err_t            err;
...
rap_int_t
rap_thread_mutex_destroy(rap_thread_mutex_t *mtx, rap_log_t *log)
{
    rap_err_t  err;
...
rap_int_t
rap_thread_mutex_lock(rap_thread_mutex_t *mtx, rap_log_t *log)
{
    rap_err_t  err;
    ...
    rap_log_error(RAP_LOG_ALERT, log, err, "pthread_mutex_lock() failed");
...
rap_int_t
rap_thread_mutex_unlock(rap_thread_mutex_t *mtx, rap_log_t *log)
{
    rap_err_t  err;
    ...
    rap_log_error(RAP_LOG_ALERT, log, err, "pthread_mutex_unlock() failed");
