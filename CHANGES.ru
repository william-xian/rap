...
Изменения в rap 1.18.0                                          21.04.2020

    *) Стабильная ветка 1.18.x.


Изменения в rap 1.17.10                                         14.04.2020

    *) Добавление: директива auth_delay.


Изменения в rap 1.17.9                                          03.03.2020

    *) Изменение: теперь rap не разрешает несколько строк "Host" в
       заголовке запроса.

    *) Исправление: rap игнорировал дополнительные строки
    ...
    *) Исправление: в модуле rap_http_mp4_module.

    *) Исправление: при перенаправлении ошибок с кодом 494 с помощью
       директивы error_page rap возвращал ответ с кодом 494 вместо 400.

    *) Исправление: утечки сокетов при использовании подзапросов в модуле
       njs и директивы aio.


Изменения в rap 1.17.8                                          21.01.2020
...
Изменения в rap 1.17.7                                          24.12.2019
    ...
    *) Исправление: в модуле rap_http_dav_module.


Изменения в rap 1.17.6                                          19.11.2019
...
Изменения в rap 1.17.5                                          22.10.2019

    *) Добавление: теперь rap использует вызов ioctl(FIONREAD), если он
    ...
    *) Исправление: rap не собирался с MinGW-w64 gcc 8.1 и новее.


Изменения в rap 1.17.4                                          24.09.2019
    ...
    *) Исправление: rap игнорировал лишние данные при использовании
       chunked transfer encoding.

    *) Исправление: если использовалась директива return и при чтении тела
       запроса возникала ошибка, rap всегда возвращал ошибку 500.

    *) Исправление: в обработке ошибок выделения памяти.


Изменения в rap 1.17.3                                          13.08.2019
...
Изменения в rap 1.17.2                                          23.07.2019
    ...
    *) Исправление: при использовании методов обработки соединений select,
       poll и /dev/poll rap мог нагружать процессор во время
       небуферизованного проксирования и при проксировании
       WebSocket-соединений.

    *) Исправление: в модуле rap_http_xslt_filter_module.

    *) Исправление: в модуле rap_http_ssi_filter_module.


Изменения в rap 1.17.1                                          25.06.2019
...
Изменения в rap 1.17.0                                          21.05.2019
...
Изменения в rap 1.15.12                                         16.04.2019
...
Изменения в rap 1.15.11                                         09.04.2019

    *) Исправление: в директиве ssl_stapling_file на Windows.


Изменения в rap 1.15.10                                         26.03.2019

    *) Изменение: теперь при использовании имени хоста в директиве listen
       rap создаёт listen-сокеты для всех адресов, соответствующих этому
    ...
    *) Исправление: rap/Windows не собирался с Visual Studio 2015 и новее;
       ошибка появилась в 1.15.9.


Изменения в rap 1.15.9                                          26.02.2019
    ...
    *) Исправление: если при использовании метода select на Windows
       происходила ошибка при установлении соединения с бэкендом, rap
...
Изменения в rap 1.15.8                                          25.12.2018
    ...
    *) Исправление: в rap/Windows.

    *) Исправление: в модуле rap_http_autoindex_module на 32-битных
       платформах.


Изменения в rap 1.15.7                                          27.11.2018
    ...
    *) Исправление: в рабочем процессе мог произойти segmentation fault,
       если использовался модуль rap_http_mp4_module на 32-битных
       платформах.


Изменения в rap 1.15.6                                          06.11.2018
    ...
    *) Безопасность: при обработке специально созданного mp4-файла модулем
       rap_http_mp4_module содержимое памяти рабочего процесса могло быть
    ...
    *) Исправление: если rap был собран с OpenSSL 1.1.0, а использовался с
...
Изменения в rap 1.15.5                                          02.10.2018
...
Изменения в rap 1.15.4                                          25.09.2018

    *) Добавление: теперь директиву ssl_early_data можно использовать с
       OpenSSL.

    *) Исправление: в модуле rap_http_uwsgi_module.
    ...
    *) Исправление: стандартные сообщения об ошибках и ответы модуля
       rap_http_autoindex_module содержали атрибут bgcolor, что могло
...
Изменения в rap 1.15.3                                          28.08.2018
    ...
    *) Исправление: модуль rap_http_dav_module при копировании файла поверх
       существующего файла с помощью метода COPY не обнулял целевой файл.

    *) Исправление: модуль rap_http_dav_module при перемещении файла между
    ...
    *) Исправление: модуль rap_http_dav_module при копировании файла с
    ...
    *) Исправление: rap не собирался с LibreSSL 2.8.0.


Изменения в rap 1.15.2                                          24.07.2018

    *) Добавление: переменная $ssl_preread_protocol в модуле
       rap_stream_ssl_preread_module.

    *) Добавление: теперь при использовании директивы
       reset_timedout_connection rap сбрасывает соединения, закрываемые с
       кодом 444.
...
Изменения в rap 1.15.1                                          03.07.2018
...
Изменения в rap 1.15.0                                          05.06.2018
    ...
    *) Изменение: теперь при использовании директивы listen с параметром ssl
       rap определяет отсутствие SSL-сертификатов при тестировании
       конфигурации.
    ...
    *) Исправление: rap не собирался gcc 8.1.

    *) Исправление: логгирование в syslog останавливалось при изменении
       локального IP-адреса.

    *) Исправление: rap не собирался компилятором clang, если был
    ...
    *) Исправление: rap не собирался на Fedora 28 Linux.
...
Изменения в rap 1.13.10                                         20.03.2018
    ...
    *) Добавление: теперь rap использует вызов
    ...
    *) Добавление: модуль rap_http_grpc_module.
...
Изменения в rap 1.13.9                                          20.02.2018
    ...
    *) Исправление: в модуле rap_http_v2_module.

    *) Исправление: в модуле rap_http_dav_module.


Изменения в rap 1.13.8                                          26.12.2017
    ...
    *) Добавление: теперь при использовании параметра transparent директив
       ...
       rap автоматически сохраняет capability CAP_NET_RAW в рабочих
       процессах.
    ...
    *) Исправление: процедура обновления исполняемого файла не работала,
       ...
       процессом rap'а становился процесс с PID, отличным от 1.

    *) Исправление: модуль rap_http_autoindex_module неправильно обрабатывал
       запросы с телом.
...
Изменения в rap 1.13.7                                          21.11.2017
    ...
    *) Исправление: в модуле rap_http_fastcgi_module.

    *) Исправление: rap возвращал ошибку 500, если в директиве
...
Изменения в rap 1.13.6                                          10.10.2017
    ...
    *) Исправление: rap не поддерживал даты после 2038 года на 32-битных
    ...
    *) Исправление: при использовании HTTP/2 rap мог вернуть ошибку 400,
    ...
    *) Исправление: при использовании директивы "hash ... consistent" в
       блоке upstream rap нагружал процессор, если использовались большие
       веса и все или почти все бэкенды были недоступны.


Изменения в rap 1.13.5                                          05.09.2017
...
Изменения в rap 1.13.4                                          08.08.2017

    *) Добавление: модуль rap_http_mirror_module.
...
Изменения в rap 1.13.3                                          11.07.2017
...
Изменения в rap 1.13.2                                          27.06.2017

    *) Изменение: теперь при запросе диапазона, начинающегося с 0, из
       пустого файла rap возвращает ответ 200 вместо 416.

    *) Добавление: директива add_trailer.
       Спасибо Piotr Sikora.

    *) Исправление: rap не собирался под Cygwin и NetBSD; ошибка появилась
       в 1.13.0.

    *) Исправление: rap не собирался под MSYS2 / MinGW 64-bit.
...
Изменения в rap 1.13.1                                          30.05.2017
    ...
    *) Изменение: rap не собирался с Oracle Developer Studio 12.5.
...
Изменения в rap 1.13.0                                          25.04.2017
...
Изменения в rap 1.11.13                                         04.04.2017
    ...
    *) Исправление: в модуле rap_http_slice_module.


Изменения в rap 1.11.12                                         24.03.2017

    *) Исправление: rap мог нагружать процессор; ошибка появилась в
       1.11.11.


Изменения в rap 1.11.11                                         21.03.2017
...
Изменения в rap 1.11.10                                         14.02.2017
    ...
    *) Добавление: теперь rap может кэшировать ответы со строкой Vary
    ...
    *) Исправление: модуль rap_http_slice_module не работал в именованных
       location'ах.
...
Изменения в rap 1.11.9                                          24.01.2017

    *) Исправление: при использовании модуля stream rap мог нагружать
...
Изменения в rap 1.11.8                                          27.12.2016
    ...
    *) Исправление: в модуле rap_stream_ssl_preread_module.
    ...
    *) Исправление: rap/Windows не собирался с 64-битным Visual Studio.

    *) Исправление: rap/Windows не собирался с OpenSSL 1.1.0.


Изменения в rap 1.11.7                                          13.12.2016
    ...
    *) Исправление: в модуле rap_http_perl_module.


Изменения в rap 1.11.6                                          15.11.2016
    ...
    *) Добавление: поддержка WebP в модуле rap_http_image_filter_module.

    *) Добавление: директива proxy_method поддерживает переменные.
       Спасибо Дмитрию Лазуркину.

    *) Добавление: директива http2_max_requests в модуле rap_http_v2_module.
    ...
    *) Исправление: если во время SSL handshake с бэкендом происходил
       таймаут, rap ничего не писал в лог и возвращал ответ с кодом 502
       вместо 504.


Изменения в rap 1.11.5                                          11.10.2016
    ...
    *) Изменение: теперь, если в блоке upstream не оказалось доступных
       серверов, rap не сбрасывает статистику ошибок всех серверов, как
       делал ранее, а ожидает истечения fail_timeout.

    *) Добавление: модуль rap_stream_ssl_preread_module.
    ...
    *) Исправление: rap возвращал ошибку 400 на запросы с символом "-" в
       HTTP-методе.


Изменения в rap 1.11.4                                          13.09.2016
    ...
    *) Добавление: модуль rap_stream_log_module.
    ...
    *) Добавление: модуль rap_stream_realip_module.

    *) Исправление: rap не собирался с модулем stream и модулем
       rap_http_ssl_module, но без модуля rap_stream_ssl_module; ошибка
       появилась в 1.11.3.
...
Изменения в rap 1.11.3                                          26.07.2016

    *) Изменение: теперь accept_mutex по умолчанию выключен.

    *) Добавление: теперь rap использует EPOLLEXCLUSIVE на Linux.

    *) Добавление: модуль rap_stream_geo_module.

    *) Добавление: модуль rap_stream_geoip_module.

    *) Добавление: модуль rap_stream_split_clients_module.
...
Изменения в rap 1.11.2                                          05.07.2016

    *) Изменение: теперь rap всегда использует внутренние реализации MD5 и
       SHA1; параметры configure --with-md5 и --with-sha1 упразднены.

    *) Добавление: поддержка переменных в модуле stream.

    *) Добавление: модуль rap_stream_map_module.

    *) Добавление: модуль rap_stream_return_module.

    *) Добавление: в директивах proxy_bind, fastcgi_bind, memcached_bind,
       scgi_bind и uwsgi_bind теперь можно указывать порт.

    *) Добавление: теперь rap использует опцию сокета
...
Изменения в rap 1.11.1                                          31.05.2016
...
Изменения в rap 1.11.0                                          24.05.2016
    ...
    *) Добавление: теперь при использовании метода epoll rap проверяет,
    ...
    *) Добавление: модуль rap_http_realip_module теперь позволяет
...
Изменения в rap 1.9.14                                          05.04.2016
...
Изменения в rap 1.9.13                                          29.03.2016
    ...
    *) Добавление: модуль rap_http_perl_module теперь можно собрать
       динамически.
    ...
    *) Исправление: rap мог нагружать процессор при использовании
    ...
    *) Исправление: в модуле rap_http_sub_filter_module.
...
Изменения в rap 1.9.12                                          24.02.2016
    ...
    *) Исправление: rap не собирался статически с OpenSSL на Linux; ошибка
       появилась в 1.9.11.
...
Изменения в rap 1.9.11                                          09.02.2016
...
Изменения в rap 1.9.10                                          26.01.2016
...
Изменения в rap 1.9.7                                           17.11.2015
    ...
    *) Исправление: если rap был собран с модулем rap_http_v2_module,
...
Изменения в rap 1.9.6                                           27.10.2015
    ...
    *) Исправление: rap/Windows не собирался с MinGW gcc; ошибка появилась
       в 1.9.4.
...
Изменения в rap 1.9.5                                           22.09.2015

    *) Добавление: модуль rap_http_v2_module (заменяет модуль
       rap_http_spdy_module).
    ...
    *) Изменение: теперь rap ограничивает максимальную вложенность
       подзапросов, а не количество одновременных подзапросов.

    *) Изменение: теперь при возврате ответов из кэша rap проверяет ключ
       полностью.
...
Изменения в rap 1.9.4                                           18.08.2015
    ...
    *) Исправление: rap не собирался с Visual Studio 2015.


Изменения в rap 1.9.3                                           14.07.2015
...
Изменения в rap 1.9.2                                           16.06.2015
...
Изменения в rap 1.9.1                                           26.05.2015
    ...
    *) Исправление: rap мог не запускаться на некоторых старых версиях
...
Изменения в rap 1.9.0                                           28.04.2015
...
Изменения в rap 1.7.12                                          07.04.2015
    ...
    *) Исправление: в модуле rap_http_spdy_module.


Изменения в rap 1.7.11                                          24.03.2015

    *) Изменение: параметр sendfile директивы aio более не нужен; теперь
       rap автоматически использует AIO для подгрузки данных для sendfile,
...
Изменения в rap 1.7.10                                          10.02.2015
    ...
    *) Изменение: теперь при переполнении диска rap пытается писать
    ...
    *) Исправление: при использовании директивы sendfile на OS X возникали
       ошибки "sendfile() failed"; ошибка появилась в rap 1.7.8.

    *) Исправление: в лог могли писаться сообщения "sem_post() failed".

    *) Исправление: rap не собирался с musl libc.
       Спасибо James Taylor.

    *) Исправление: rap не собирался на Tru64 UNIX.
       Спасибо Goetz T. Fischer.


Изменения в rap 1.7.9                                           23.12.2014
...
Изменения в rap 1.7.8                                           02.12.2014
    ...
    *) Исправление: rap игнорировал значение "s-maxage" в строке
    ...
    *) Исправление: при использовании директивы post_action в лог писались
       сообщения "header already sent"; ошибка появилась в rap 1.5.4.
...
Изменения в rap 1.7.7                                           28.10.2014

    *) Изменение: теперь rap учитывает при кэшировании строку "Vary" в
    ...
    *) Исправление: rap/Windows не собирался с MinGW-w64 gcc.
       Спасибо Kouhei Sutou.


Изменения в rap 1.7.6                                           30.09.2014
...
Изменения в rap 1.7.5                                           16.09.2014
    ...
    *) Исправление: в модуле rap_http_spdy_module при использовании
       совместно с AIO.
...
Изменения в rap 1.7.4                                           05.08.2014
    ...
    *) Добавление: теперь rap можно собрать с BoringSSL и LibreSSL.
       Спасибо Piotr Sikora.
...
Изменения в rap 1.7.3                                           08.07.2014
...
Изменения в rap 1.7.1                                           27.05.2014
    ...
    *) Исправление: rap не собирался с параметром --with-file-aio на
       Linux/aarch64.


Изменения в rap 1.7.0                                           24.04.2014
...
Изменения в rap 1.5.13                                          08.04.2014
    ...
    *) Добавление: модуль rap_http_mp4_module теперь понимает аргумент end.

    *) Добавление: поддержка byte ranges модулем rap_http_mp4_module и при
       сохранении ответов в кэш.

    *) Исправление: теперь rap не пишет в лог сообщения "rap_slab_alloc()
       failed: no memory" при использовании разделяемой памяти в
       ssl_session_cache и в модуле rap_http_limit_req_module.
    ...
    *) Исправление: при использовании ssl_session_cache с параметром shared
       рабочий процесс rap/Windows завершался аварийно.

    *) Исправление: в модуле rap_http_spdy_module.


Изменения в rap 1.5.12                                          18.03.2014

    *) Безопасность: при обработке специально созданного запроса модулем
       rap_http_spdy_module могло происходить переполнение буфера в рабочем
...
Изменения в rap 1.5.11                                          04.03.2014

    *) Безопасность: при обработке специально созданного запроса модулем
       rap_http_spdy_module на 32-битных платформах могла повреждаться
    ...
    *) Исправление: в рабочем процессе мог произойти segmentation fault,
       если использовался модуль rap_http_spdy_module на 32-битных
    ...
    *) Исправление: rap/Windows не собирался с Visual Studio 2013.


Изменения в rap 1.5.10                                          04.02.2014

    *) Добавление: модуль rap_http_spdy_module теперь использует протокол
       SPDY 3.1.
       Спасибо Automattic и MaxCDN за спонсирование разработки.

    *) Добавление: модуль rap_http_mp4_module теперь пропускает дорожки,
    ...
    *) Исправление: переменные $date_local и $date_gmt использовали неверный
       формат вне модуля rap_http_ssi_filter_module.
...
Изменения в rap 1.5.9                                           22.01.2014

    *) Изменение: теперь в заголовке X-Accel-Redirect rap ожидает
       закодированный URI.
    ...
    *) Исправление: rap неправильно обрабатывал закодированный символ "?"
       в команде SSI include.

    *) Исправление: модуль rap_http_dav_module не раскодировал целевой URI
    ...
    *) Исправление: в рабочем процессе мог произойти segmentation fault,
       если использовался модуль rap_http_spdy_module.
...
Изменения в rap 1.5.8                                           17.12.2013
    ...
    *) Добавление: поддержка SSL в модуле rap_http_uwsgi_module.
...
Изменения в rap 1.5.7                                           19.11.2013
    ...
    *) Исправление: ответы могли зависать, если использовался модуль
       rap_http_spdy_module и директива auth_request.

    *) Исправление: утечки памяти в rap/Windows.


Изменения в rap 1.5.6                                           01.10.2013
    ...
    *) Исправление: в модуле rap_http_auth_basic_module при использовании
       метода шифрования паролей "$apr1$".
       Спасибо Markus Linnala.

    *) Исправление: на MacOSX, Cygwin и rap/Windows для обработки запроса
...
Изменения в rap 1.5.5                                           17.09.2013

    *) Изменение: теперь rap по умолчанию использует HTTP/1.0, если точно
    ...
    *) Исправление: переменная $request_time не работала в rap/Windows.
...
Изменения в rap 1.5.4                                           27.08.2013
    ...
    *) Добавление: модуль rap_http_auth_request_module.
    ...
    *) Исправление: в модуле rap_http_autoindex_module.

    *) Исправление: в модуле rap_http_spdy_module.


Изменения в rap 1.5.3                                           30.07.2013

    *) Изменение во внутреннем API: теперь при небуферизированной работе с
       бэкендами u->length по умолчанию устанавливается в -1.

    *) Изменение: теперь при получении неполного ответа от бэкенда rap
       отправляет полученную часть ответа, после чего закрывает соединение с
       клиентом.

    *) Исправление: в рабочем процессе мог произойти segmentation fault,
       если использовался модуль rap_http_spdy_module и директива
...
Изменения в rap 1.5.2                                           02.07.2013
    ...
    *) Исправление: rap не собирался на Linux при использовании x32 ABI.
       Спасибо Сергею Иванцову.


Изменения в rap 1.5.1                                           04.06.2013
    ...
    *) Исправление: rap не собирался с модулем rap_mail_ssl_module, но без
       модуля rap_http_ssl_module; ошибка появилась в 1.3.14.
    ...
    *) Исправление: rap/Windows мог перестать принимать соединения, если
       использовалось несколько рабочих процессов.


Изменения в rap 1.5.0                                           07.05.2013
...
Изменения в rap 1.4.0                                           24.04.2013

    *) Исправление: rap не собирался с модулем rap_http_perl_module, если
       использовался параметр --with-openssl; ошибка появилась в 1.3.16.

    *) Исправление: в работе с телом запроса из модуля rap_http_perl_module;
       ошибка появилась в 1.3.9.


Изменения в rap 1.3.16                                          16.04.2013
...
Изменения в rap 1.3.15                                          26.03.2013
    ...
    *) Добавление: модуль rap_http_spdy_module.
...
Изменения в rap 1.3.14                                          05.03.2013

    *) Добавление: переменные $connections_active, $connections_reading и
       $connections_writing в модуле rap_http_stub_status_module.

    *) Добавление: поддержка WebSocket-соединений в модулях
       rap_http_uwsgi_module и rap_http_scgi_module.
...
Изменения в rap 1.3.13                                          19.02.2013
...
Изменения в rap 1.3.12                                          05.02.2013
    ...
    *) Добавление: поддержка IPv6 в модуле rap_http_geoip_module.
    ...
    *) Исправление: rap мог нагружать процессор во время SSL handshake с
...
Изменения в rap 1.3.11                                          10.01.2013
...
Изменения в rap 1.3.10                                          25.12.2012
    ...
    *) Исправление: rap в некоторых случаях не собирался с модулем
       rap_http_perl_module.

    *) Исправление: в рабочем процессе мог произойти segmentation fault,
       если использовался модуль rap_http_xslt_module.

    *) Исправление: rap мог не собираться на MacOSX.
       Спасибо Piotr Sikora.
...
Изменения в rap 1.3.9                                           27.11.2012
...
Изменения в rap 1.3.8                                           30.10.2012
    ...
    *) Исправление: в модуле rap_http_gunzip_filter_module.

    *) Исправление: в директиве ssl_stapling.


Изменения в rap 1.3.7                                           02.10.2012
...
Изменения в rap 1.3.6                                           12.09.2012

    *) Добавление: модуль rap_http_gunzip_filter_module.
    ...
    *) Исправление: rap не собирался gcc 4.7 с оптимизацией -O2 если
       использовался параметр --with-ipv6.


Изменения в rap 1.3.5                                           21.08.2012

    *) Изменение: модуль rap_http_mp4_module больше не отфильтровывает
    ...
    *) Исправление: rap/Windows не собирался с Visual Studio 2005 Express.
       Спасибо HAYASHI Kentaro.


Изменения в rap 1.3.4                                           31.07.2012
    ...
    *) Исправление: rap/Windows мог нагружать процессор, если при запуске
...
Изменения в rap 1.3.3                                           10.07.2012
...
Изменения в rap 1.3.2                                           26.06.2012
    ...
    *) Исправление: в рабочем процессе мог произойти segmentation fault,
       если использовался модуль rap_http_mp4_module.
    ...
    *) Исправление: на платформе ARM rap мог аварийно завершаться по
       сигналу SIGBUS.
...
Изменения в rap 1.3.1                                           05.06.2012

    *) Безопасность: теперь rap/Windows игнорирует точку в конце
    ...
    *) Исправление: rap не собирался с модулем rap_cpp_test_module; ошибка
       появилась в 1.1.12.
...
Изменения в rap 1.3.0                                           15.05.2012
    ...
    *) Исправление: rap мог нагружать процессор, если было достигнуто
       ограничение на количество открытых файлов.

    *) Исправление: при использовании директивы proxy_next_upstream с
       параметром http_404 rap мог бесконечно перебирать бэкенды, если в
...
Изменения в rap 1.2.0                                           23.04.2012
...
Изменения в rap 1.1.19                                          12.04.2012

    *) Безопасность: при обработке специально созданного mp4 файла модулем
       rap_http_mp4_module могли перезаписываться области памяти рабочего
       процесса, что могло приводить к выполнению произвольного кода
       (CVE-2012-2089).
       Спасибо Matthew Daley.

    *) Исправление: rap/Windows мог завершаться аварийно.
       Спасибо Vincent Lee.

    *) Исправление: rap нагружал процессор, если все серверы в upstream'е
...
Изменения в rap 1.1.18                                          28.03.2012
    ...
    *) Исправление: rap не собирался на Debian GNU/Hurd.


Изменения в rap 1.1.17                                          15.03.2012
...
Изменения в rap 1.1.16                                          29.02.2012
    ...
    *) Исправление: rap не собирался компилятором icc 12.1.

    *) Исправление: rap не собирался gcc на Solaris; ошибка появилась в
       1.1.15.


Изменения в rap 1.1.15                                          15.02.2012

    *) Добавление: директива disable_symlinks.

    *) Добавление: директивы proxy_cookie_domain и proxy_cookie_path.

    *) Исправление: rap мог некорректно сообщать об ошибке "upstream
    ...
    *) Исправление: вызов $r->flush() несколько раз подряд мог приводить к
       ошибкам в модуле rap_http_gzip_filter_module.
...
Изменения в rap 1.1.14                                          30.01.2012
...
Изменения в rap 1.1.13                                          16.01.2012
    ...
    *) Исправление: rap не собирался на Solaris; ошибка появилась в
       1.1.12.

    *) Исправление: в модуле rap_http_mp4_module.


Изменения в rap 1.1.12                                          26.12.2011
    ...
    *) Исправление: в модуле rap_http_scgi_module.

    *) Исправление: в модуле rap_http_mp4_module.

    *) Исправление: rap не собирался на Solaris; ошибка появилась в 1.1.9.


Изменения в rap 1.1.11                                          12.12.2011
...
Изменения в rap 1.1.9                                           28.11.2011
    ...
    *) Исправление: rap мог перестать отвечать, если рабочий процесс
       завершался аварийно.
    ...
    *) Исправление: в модуле rap_http_flv_module.
       Спасибо Piotr Sikora.

    *) Исправление: в модуле rap_http_mp4_module.

    *) Исправление: теперь rap понимает IPv6-адреса в строке запроса и в
       заголовке Host.

    *) Исправление: директивы add_header и expires не работали для ответов с
       кодом 206, если запрос проксировался.

    *) Исправление: rap не собирался на FreeBSD 10.

    *) Исправление: rap не собирался на AIX.


Изменения в rap 1.1.8                                           14.11.2011

    *) Изменение: модуль rap_http_limit_zone_module переименован в
    ...
    *) Исправление: модуль rap_http_mp4_module выдавал неверную строку
       "Content-Length" в заголовке ответа, использовался аргумент start.
       Спасибо Piotr Sikora.


Изменения в rap 1.1.7                                           31.10.2011
...
Изменения в rap 1.1.6                                           17.10.2011
    ...
    *) Исправление: директивы модуля rap_http_rewrite_module, заданные на
    ...
    *) Исправление: модуль rap_http_mp4_module не поддерживал перемотку на
       32-битных платформах.


Изменения в rap 1.1.5                                           05.10.2011
    ...
    *) Исправление: в модуле rap_http_proxy_module при работе с бэкендами по
       HTTP/1.1.

    *) Исправление: закэшированные ответы с пустым телом возвращались
       некорректно; ошибка появилась в 0.8.31.

    *) Исправление: ответы с кодом 201 модуля rap_http_dav_module были
...
Изменения в rap 1.1.4                                           20.09.2011

    *) Добавление: модуль rap_http_upstream_keepalive.
    ...
    *) Исправление: если rap был собран с файловым AIO, он не мог
    ...
    *) Исправление: модуль rap_http_mp4_module не поддерживал 64-битный
       MP4-атом co64.


Изменения в rap 1.1.3                                           14.09.2011

    *) Добавление: модуль rap_http_mp4_module.
    ...
    *) Исправление: rap не собирался на MacOSX 10.7.


Изменения в rap 1.1.2                                           05.09.2011

    *) Изменение: теперь, если суммарный размер всех диапазонов больше
       размера исходного ответа, то rap возвращает только исходный ответ,
...
Изменения в rap 1.1.1                                           22.08.2011
    ...
    *) Исправление: rap не собирался на Linux 3.0.

    *) Исправление: в некоторых случаях rap не использовал сжатие; ошибка
       появилась в 1.1.0.
...
Изменения в rap 1.1.0                                           01.08.2011
    ...
    *) Добавление: теперь rap поддерживает шифры с обменом ECDHE-ключами.
    ...
    *) Исправление: rap не запрещал сжатие при получении значения
...
Изменения в rap 1.0.5                                           19.07.2011
...
Изменения в rap 1.0.4                                           01.06.2011
    ...
    *) Исправление: rap не собирался с параметром
       --without-http_auth_basic_module; ошибка появилась в 1.0.3.


Изменения в rap 1.0.3                                           25.05.2011
    ...
    *) Добавление: модули rap_http_geo_module и rap_http_geoip_module
...
Изменения в rap 1.0.2                                           10.05.2011
    ...
    *) Исправление: rap не собирался на Solaris; ошибка появилась в 1.0.1.


Изменения в rap 1.0.1                                           03.05.2011
    ...
    *) Изменение: теперь по умолчанию rap использует значение 511 для
       listen backlog на Linux.

    *) Добавление: переменные $upstream_... можно использовать в SSI и
       перловом модулях.

    *) Исправление: теперь rap лучше ограничивает размер кэша на диске.
       Спасибо Олегу Мамонтову.
    ...
    *) Исправление: rap не собирался gcc 4.6 без параметра --with-debug.

    *) Исправление: rap не собирался на Solaris 9 и более ранних; ошибка
       появилась в 0.9.3.
...
Изменения в rap 1.0.0                                           12.04.2011
...
Изменения в rap 0.9.7                                           04.04.2011
...
Изменения в rap 0.9.6                                           21.03.2011
...
Изменения в rap 0.9.5                                           21.02.2011

    *) Изменение: теперь по умолчанию rap использует значение -1 для
       listen backlog на Linux.
...
Изменения в rap 0.9.4                                           21.01.2011
...
Изменения в rap 0.9.3                                           13.12.2010
    ...
    *) Исправление: rap не собирался под Solaris; ошибка появилась в
       0.9.0.


Изменения в rap 0.9.2                                           06.12.2010
    ...
    *) Исправление: rap не собирался под Cygwin; ошибка появилась в 0.9.0.

    *) Исправление: уязвимости в OpenSSL CVE-2010-4180.
       Спасибо Максиму Дунину.


Изменения в rap 0.9.1                                           30.11.2010

    *) Исправление: директивы вида "return CODE message" не работали; ошибка
       появилась в 0.9.0.


Изменения в rap 0.9.0                                           29.11.2010
    ...
    *) Добавление: страница руководства rap(8).
    ...
    *) Исправление: совместимость с модулем rap_http_eval_module; ошибка
       появилась в 0.8.42.


Изменения в rap 0.8.53                                          18.10.2010
...
Изменения в rap 0.8.52                                          28.09.2010

    *) Исправление: rap использовал режим SSL для listen сокета, если для
       него был установлен любой listen-параметр; ошибка появилась в 0.8.51.


Изменения в rap 0.8.51                                          27.09.2010
...
Изменения в rap 0.8.50                                          02.09.2010

    *) Добавление: директивы secure_link, secure_link_md5 и
       secure_link_expires модуля rap_http_secure_link_module.
    ...
    *) Исправление: rap/Windows не мог посылать сигналы stop, quit,
       reopen, reload процессу, запущенному в другой сессии.


Изменения в rap 0.8.49                                          09.08.2010
...
Изменения в rap 0.8.48                                          03.08.2010
    ...
    *) Исправление: модуль rap_http_image_filter_module закрывал соединение,
       если изображение было больше размера image_filter_buffer.


Изменения в rap 0.8.47                                          28.07.2010
...
Изменения в rap 0.8.46                                          19.07.2010
    ...
    *) Исправление: rap не освобождал память в keys_zone кэшей в случае
       ошибки работы с бэкендом: память освобождалась только по истечении
       времени неактивности или при недостатке памяти.


Изменения в rap 0.8.45                                          13.07.2010

    *) Добавление: улучшения в модуле rap_http_xslt_filter.
...
Изменения в rap 0.8.44                                          05.07.2010

    *) Изменение: теперь rap по умолчанию не кэширует ответы бэкендов, в
    ...
    *) Исправление: rap считал большие пакеты SSLv2 как обычные текстовые
       запросы.
       Спасибо Miroslaw Jaworski.


Изменения в rap 0.8.43                                          30.06.2010
    ...
    *) Исправление: rap мог закрывать IPv6 listen сокет во время
       переконфигурации.
       Спасибо Максиму Дунину.
...
Изменения в rap 0.8.42                                          21.06.2010

    *) Изменение: теперь rap проверяет location'ы, заданные регулярными
       выражениями, если запрос полностью совпал с location'ом, заданным
       строкой префикса. Предыдущее поведение появилось в 0.7.1.

    *) Добавление: модуль rap_http_scgi_module.
       Спасибо Manlio Perillo.

    *) Добавление: в директиве return можно добавлять текст ответа.


Изменения в rap 0.8.41                                          15.06.2010

    *) Безопасность: рабочий процесс rap/Windows мог завершаться аварийно
       при запросе файла с неверной кодировкой UTF-8.

    *) Изменение: теперь rap разрешает использовать пробелы в строке
       запроса.
    ...
    *) Исправление: rap не поддерживал путь без имени хоста в строке
       "Destination" в заголовке запроса.


Изменения в rap 0.8.40                                          07.06.2010

    *) Безопасность: теперь rap/Windows игнорирует имя потока файла по
       умолчанию.
       Спасибо Jose Antonio Vazquez Gonzalez.

    *) Добавление: модуль rap_http_uwsgi_module.
       Спасибо Roberto De Ioris.
...
Изменения в rap 0.8.39                                          31.05.2010
...
Изменения в rap 0.8.38                                          24.05.2010
...
Изменения в rap 0.8.37                                          17.05.2010

    *) Добавление: модуль rap_http_split_clients_module.

    *) Добавление: директива map поддерживает ключи больше 255 символов.

    *) Исправление: rap игнорировал значения "private" и "no-store" в
...
Изменения в rap 0.8.36                                          22.04.2010

    *) Исправление: модуль rap_http_dav_module неправильно обрабатывал
    ...
    *) Исправление: rap не собирался с параметром --without-http-cache;
       ошибка появилась в 0.8.35.


Изменения в rap 0.8.35                                          01.04.2010
    ...
    *) Исправление: rap мог завершаться аварийно во время обработки
    ...
    *) Исправление: модуль rap_http_memcached_module мог выдавать ошибку
       "memcached sent invalid trailer".
       Спасибо Максиму Дунину.

    *) Исправление: rap не мог собрать библиотеку zlib-1.2.4 из исходных
       текстов.
       Спасибо Максиму Дунину.
...
Изменения в rap 0.8.34                                          03.03.2010

    *) Исправление: rap не поддерживал все шифры, используемые в
       клиентских сертификатах.
       Спасибо Иннокентию Еникееву.

    *) Исправление: rap неправильно кэшировал FastCGI-ответы, если перед
       ответом было много вывода в stderr.

    *) Исправление: rap не поддерживал HTTPS-рефереры.

    *) Исправление: rap/Windows мог не находить файлы, если путь в
...
Изменения в rap 0.8.33                                          01.02.2010

    *) Безопасность: теперь rap/Windows игнорирует пробелы в конце URI.
       Спасибо Dan Crowley, Core Security Technologies.

    *) Безопасность: теперь rap/Windows игнорирует короткие имена файлов.
       Спасибо Dan Crowley, Core Security Technologies.
...
Изменения в rap 0.8.32                                          11.01.2010
    ...
    *) Исправление: rap не поддерживал передачу chunk'ами для 201-ых
       ответов.
...
Изменения в rap 0.8.31                                          23.12.2009
    ...
    *) Добавление: модуль rap_http_image_filter_module теперь всегда удаляет
       EXIF и другие данные, если они занимают больше 5% в JPEG-файле.

    *) Исправление: rap закрывал соединение при запросе закэшированного
       ответа с пустым телом.
       Спасибо Piotr Sikora.

    *) Исправление: rap мог не собираться gcc 4.x при использовании
    ...
    *) Исправление: rap кэшировал 304 ответ, если в заголовке
       проксируемого запроса была строка "If-None-Match".
       Спасибо Tim Dettrick и David Kostal.

    *) Исправление: rap/Windows пытался дважды удалить временный файл при
       перезаписи уже существующего файла.


Изменения в rap 0.8.30                                          15.12.2009
    ...
    *) Исправление: rap/Windows пытался дважды переименовать временный
...
Изменения в rap 0.8.29                                          30.11.2009
...
Изменения в rap 0.8.28                                          23.11.2009

    *) Исправление: rap не собирался с параметром --without-pcre; ошибка
       появилась в 0.8.25.


Изменения в rap 0.8.27                                          17.11.2009

    *) Исправление: регулярные выражения не работали в rap/Windows; ошибка
       появилась в 0.8.25.


Изменения в rap 0.8.26                                          16.11.2009

    *) Исправление: ошибки при использовании выделений в директиве rewrite;
       ошибка появилась в 0.8.25.

    *) Исправление: rap не собирался без параметра --with-debug; ошибка
       появилась в 0.8.25.


Изменения в rap 0.8.25                                          16.11.2009

    *) Изменение: теперь в лог ошибок не пишется сообщение, если переменная
       не найдена с помощью метода $r->variable().

    *) Добавление: модуль rap_http_degradation_module.
    ...
    *) Исправление: rap передавал сжатые ответы клиентам, не
       поддерживающим сжатие, при настройках gzip_static on и gzip_vary off;
       ошибка появилась в 0.8.16.


Изменения в rap 0.8.24                                          11.11.2009

    *) Исправление: rap всегда добавлял строку "Content-Encoding: gzip" в
       заголовок 304-ых ответов модуля rap_http_gzip_static_module.
...
Изменения в rap 0.8.23                                          11.11.2009
...
Изменения в rap 0.8.22                                          03.11.2009
    ...
    *) Исправление: rap не удалял unix domain сокет после тестирования
       конфигурации.

    *) Исправление: rap удалял unix domain сокет во время обновления без
       перерыва.
...
Изменения в rap 0.8.21                                          26.10.2009
    ...
    *) Исправление: rap не поддерживал даты в 2038 году на 32-битных
       платформах;

    *) Исправление: утечки сокетов; ошибка появилась в 0.8.11.


Изменения в rap 0.8.20                                          14.10.2009

    *) Изменение: теперь по умолчанию используются следующие шифры SSL:
       "HIGH:!ADH:!MD5".

    *) Исправление: модуль rap_http_autoindex_module не показывал последний
       слэш для линков на каталоги; ошибка появилась в 0.7.15.

    *) Исправление: rap не закрывал лог, заданный параметром конфигурации
       --error-log-path; ошибка появилась в 0.7.53.

    *) Исправление: rap не считал запятую разделителем в строке
       "Cache-Control" в заголовке ответа бэкенда.

    *) Исправление: rap/Windows мог не создать временный файл, файл в кэше
    ...
    *) Исправление: rap неверно считал размер кэша на диске.


Изменения в rap 0.8.19                                          06.10.2009
...
Изменения в rap 0.8.18                                          06.10.2009
    ...
    *) Исправление: rap не работал на Linux/sparc.
       Спасибо Marcus Ramberg.

    *) Исправление: rap слал символ '\0' в строке "Location" в заголовке в
...
Изменения в rap 0.8.17                                          28.09.2009
...
Изменения в rap 0.8.16                                          22.09.2009
    ...
    *) Исправление: rap всегда добавлял строку "Vary: Accept-Encoding" в
...
Изменения в rap 0.8.15                                          14.09.2009
...
Изменения в rap 0.8.14                                          07.09.2009
...
Изменения в rap 0.8.13                                          31.08.2009

    *) Исправление: в директиве "aio sendfile"; ошибка появилась в 0.8.12.

    *) Исправление: rap не собирался без параметра --with-file-aio на
       FreeBSD; ошибка появилась в 0.8.12.


Изменения в rap 0.8.12                                          31.08.2009
...
Изменения в rap 0.8.11                                          28.08.2009
...
Изменения в rap 0.8.10                                          24.08.2009
...
Изменения в rap 0.8.9                                           17.08.2009
...
Изменения в rap 0.8.8                                           10.08.2009
...
Изменения в rap 0.8.7                                           27.07.2009
...
Изменения в rap 0.8.5                                           13.07.2009

    *) Исправление: теперь rap разрешает подчёркивания в методе запроса.

    *) Исправление: при использовании HTTP Basic-аутентификации на Windows
       для неверных имени/пароля возвращалась 500-ая ошибка.

    *) Исправление: ответы модуля rap_http_perl_module не работали в
       подзапросах.

    *) Исправление: в модуле rap_http_limit_req_module.
       Спасибо Максиму Дунину.


Изменения в rap 0.8.4                                           22.06.2009

    *) Исправление: rap не собирался с параметром --without-http-cache;
       ошибка появилась в 0.8.3.


Изменения в rap 0.8.3                                           19.06.2009

    *) Добавление: переменная $upstream_cache_status.

    *) Исправление: rap не собирался на MacOSX 10.6.
...
Изменения в rap 0.8.2                                           15.06.2009
...
Изменения в rap 0.8.1                                           08.06.2009
    ...
    *) Исправление: модуль rap_http_image_filter_module не понимал формат
       GIF87a.
       Спасибо Денису Ильиных.

    *) Исправление: rap не собирался на Solaris 10 и более ранних; ошибка
       появилась в 0.7.56.


Изменения в rap 0.8.0                                           02.06.2009
    ...
    *) Исправление: обработке относительных путей в rap/Windows.

    *) Исправление: в proxy_store, fastcgi_store, proxy_cache и
       fastcgi_cache в rap/Windows.

    *) Исправление: в обработке ошибок выделения памяти.
       Спасибо Максиму Дунину и Кириллу Коринскому.


Изменения в rap 0.7.59                                          25.05.2009
    ...
    *) Исправление: ответы модуля rap_http_xslt_filter_module не
       обрабатывались SSI-, charset- и gzip-фильтрами.

    *) Исправление: директива charset не ставила кодировку для ответов
       модуля rap_http_gzip_static_module.


Изменения в rap 0.7.58                                          18.05.2009
    ...
    *) Исправление: в модуле rap_http_autoindex_module в ссылках на имена
...
Изменения в rap 0.7.57                                          12.05.2009

    *) Исправление: при перенаправлении ошибок модуля
       rap_http_image_filter_module в именованный location в рабочем
       процессе происходил floating-point fault; ошибка появилась в 0.7.56.


Изменения в rap 0.7.56                                          11.05.2009

    *) Добавление: rap/Windows поддерживает IPv6 в директиве listen модуля
       HTTP.

    *) Исправление: в модуле rap_http_image_filter_module.


Изменения в rap 0.7.55                                          06.05.2009
    ...
    *) Исправление: ошибки "select() failed (9: Bad file descriptor)" в
       rap/Unix и "select() failed (10038: ...)" в rap/Windows.
    ...
    *) Исправление: в сборке модуля rap_http_image_filter_module.
...
Изменения в rap 0.7.54                                          01.05.2009

    *) Добавление: модуль rap_http_image_filter_module.
    ...
    *) Исправление: ошибки "select() failed (10022: ...)" в rap/Windows.

    *) Исправление: в текстовых сообщениях об ошибках в rap/Windows;
       ошибка появилась в 0.7.53.


Изменения в rap 0.7.53                                          27.04.2009
    ...
    *) Добавление: при сборке с пустым параметром --prefix= rap использует
    ...
    *) Исправление: rap/Windows не работал, если файл конфигурации был
       задан ключом -c.
...
Изменения в rap 0.7.52                                          20.04.2009
    ...
    *) Исправление: если rap был собран с модулем rap_http_perl_module и
    ...
    *) Исправление: rap не собирался на платформах, отличных от i386,
       amd64, sparc и ppc; ошибка появилась в 0.7.42.


Изменения в rap 0.7.51                                          12.04.2009
...
Изменения в rap 0.7.50                                          06.04.2009

    *) Исправление: переменные $arg_... не работали; ошибка появилась в
       0.7.49.


Изменения в rap 0.7.49                                          06.04.2009
...
Изменения в rap 0.7.48                                          06.04.2009

    *) Добавление: директива proxy_cache_key.

    *) Исправление: теперь rap учитывает при кэшировании строки
       "X-Accel-Expires", "Expires" и "Cache-Control" в заголовке ответа
       бэкенда.

    *) Исправление: теперь rap кэширует только ответы на запросы GET.
    ...
    *) Исправление: rap не собирался с библиотекой uclibc.
       Спасибо Timothy Redaelli.

    *) Исправление: rap не собирался на OpenBSD; ошибка появилась
       в 0.7.46.


Изменения в rap 0.7.47                                          01.04.2009

    *) Исправление: rap не собирался на FreeBSD 6 и более ранних версиях;
       ошибка появилась в 0.7.46.

    *) Исправление: rap не собирался на MacOSX; ошибка появилась в 0.7.46.
...
Изменения в rap 0.7.46                                          30.03.2009

    *) Исправление: архив предыдущего релиза был неверным.


Изменения в rap 0.7.45                                          30.03.2009
...
Изменения в rap 0.7.44                                          23.03.2009
...
Изменения в rap 0.7.43                                          18.03.2009
...
Изменения в rap 0.7.42                                          16.03.2009
    ...
    *) Исправление: rap не собирался без библиотеки PCRE; ошибка появилась
       в 0.7.41.


Изменения в rap 0.7.41                                          11.03.2009
...
Изменения в rap 0.7.40                                          09.03.2009
    ...
    *) Изменение: модуль rap_http_autoindex_module не показывал последний
       слэш для каталогов на файловой системе XFS; ошибка появилась в
       0.7.15.
       Спасибо Дмитрию Кузьменко.


Изменения в rap 0.7.39                                          02.03.2009
...
Изменения в rap 0.7.38                                          23.02.2009
...
Изменения в rap 0.7.37                                          21.02.2009

    *) Исправление: директивы, использующие upstream'ы, не работали; ошибка
       появилась в 0.7.36.


Изменения в rap 0.7.36                                          21.02.2009
...
Изменения в rap 0.7.35                                          16.02.2009
...
Изменения в rap 0.7.34                                          10.02.2009

    *) Добавление: параметр off в директиве if_modified_since.

    *) Добавление: теперь после команды XCLIENT rap посылает команду
       HELO/EHLO.
       Спасибо Максиму Дунину.
...
Изменения в rap 0.7.33                                          02.02.2009
...
Изменения в rap 0.7.32                                          26.01.2009
    ...
    *) Исправление: ошибки выделения больших блоков в разделяемой памяти,
       если rap был собран без отладки.
       Спасибо Андрею Квасову.


Изменения в rap 0.7.31                                          19.01.2009
...
Изменения в rap 0.7.29                                          24.12.2008
    ...
    *) Исправление: в выделении памяти в модуле rap_http_gzip_filter_module
       под Cygwin.


Изменения в rap 0.7.28                                          22.12.2008

    *) Изменение: в выделении памяти в модуле rap_http_gzip_filter_module.

    *) Изменение: значения по умолчанию для директивы gzip_buffers изменены
       с 4 4k/8k на 32 4k или 16 8k.


Изменения в rap 0.7.27                                          15.12.2008
    ...
    *) Исправление: при запросе файла нулевой длины rap закрывал
...
Изменения в rap 0.7.26                                          08.12.2008

    *) Исправление: в обработке подзапросов; ошибка появилась в 0.7.25.


Изменения в rap 0.7.25                                          08.12.2008
...
Изменения в rap 0.7.24                                          01.12.2008

    *) Добавление: директива if_modified_since.

    *) Исправление: rap не обрабатывал ответ FastCGI-сервера, если перед
...
Изменения в rap 0.7.23                                          27.11.2008
...
Изменения в rap 0.7.22                                          20.11.2008
...
Изменения в rap 0.7.21                                          11.11.2008

    *) Изменения в модуле rap_http_limit_req_module.

    *) Добавление: поддержка EXSLT в модуле rap_http_xslt_module.
       Спасибо Денису Латыпову.

    *) Изменение: совместимость с glibc 2.3.
       Спасибо Eric Benson и Максиму Дунину.

    *) Исправление: rap не запускался на MacOSX 10.4 и более ранних;
       ошибка появилась в 0.7.6.


Изменения в rap 0.7.20                                          10.11.2008

    *) Изменения в модуле rap_http_gzip_filter_module.

    *) Добавление: модуль rap_http_limit_req_module.
    ...
    *) Исправление: модуль rap_http_secure_link_module не работал внутри
       location'ов с именами меньше 3 символов.

    *) Исправление: переменная $server_addr могла не иметь значения.


Изменения в rap 0.7.19                                          13.10.2008

    *) Исправление: обновление номера версии.


Изменения в rap 0.7.18                                          13.10.2008

    *) Изменение: директива underscores_in_headers; теперь rap по
       умолчанию не разрешает подчёркивания в именах строк в заголовке
       запроса клиента.

    *) Добавление: модуль rap_http_secure_link_module.
    ...
    *) Исправление: rap мог выдавать строку "Transfer-Encoding: chunked"
       для запросов HEAD.

    *) Исправление: теперь accept-лимит зависит от числа worker_connections.


Изменения в rap 0.7.17                                          15.09.2008
    ...
    *) Исправление: модуль rap_http_charset_module не понимал название
       кодировки в кавычках, полученное от бэкенда.


Изменения в rap 0.7.16                                          08.09.2008

    *) Исправление: rap не собирался на 64-битных платформах; ошибка
       появилась в 0.7.15.


Изменения в rap 0.7.15                                          08.09.2008

    *) Добавление: модуль rap_http_random_index_module.
    ...
    *) Добавление: теперь rap разрешает подчёркивания в именах строк в
       заголовке запроса клиента.


Изменения в rap 0.7.14                                          01.09.2008
    ...
    *) Добавление: теперь при переконфигурации rap учитывает изменение
...
Изменения в rap 0.7.13                                          26.08.2008

    *) Исправление: rap не собирался на Linux и Solaris; ошибка появилась
       в 0.7.12.


Изменения в rap 0.7.12                                          26.08.2008
...
Изменения в rap 0.7.11                                          18.08.2008

    *) Изменение: теперь rap_http_charset_module по умолчанию не работает
       MIME-типом text/css.

    *) Добавление: теперь rap возвращает код 405 для метода POST при
    ...
    *) Исправление: если у каталога были права доступа только на поиск
       файлов и первый индексный файл отсутствовал, то rap возвращал
       ошибку 500.
...
Изменения в rap 0.7.10                                          13.08.2008
    ...
    *) Исправление: теперь модуль rap_http_realip_module устанавливает адрес
       не для всего keepalive соединения, а для каждого запроса по этому
       соединению.


Изменения в rap 0.7.9                                           12.08.2008

    *) Изменение: теперь rap_http_charset_module по умолчанию работает со
    ...
    *) Добавление: модуль rap_cpp_test_module.

    *) Добавление: директива expires поддерживает суточное время.

    *) Добавление: улучшения и исправления в модуле rap_http_xslt_module.
...
Изменения в rap 0.7.8                                           04.08.2008

    *) Добавление: модуль rap_http_xslt_module.
    ...
    *) Исправление: теперь, если FastCGI-сервер присылает строку "Location"
       в заголовке ответа без строки статуса, то rap использует код
       статуса 302.
       Спасибо Максиму Дунину.


Изменения в rap 0.7.7                                           30.07.2008
...
Изменения в rap 0.7.6                                           07.07.2008
    ...
    *) Исправление: модуль rap_http_flv_module не поддерживал несколько
       значений в аргументах запроса.


Изменения в rap 0.7.5                                           01.07.2008
...
Изменения в rap 0.7.4                                           30.06.2008
...
Изменения в rap 0.7.3                                           23.06.2008
...
Изменения в rap 0.7.2                                           16.06.2008

    *) Добавление: теперь rap поддерживает шифры с обменом EDH-ключами.
    ...
    *) Исправление: после изменения URI с помощью директивы rewrite rap не
    ...
    *) Исправление: при редиректе запроса к каталогу с добавлением слэша
       rap не добавлял аргументы из оригинального запроса.


Изменения в rap 0.7.1                                           26.05.2008
    ...
    *) Исправление: rap не собирался на последних Fedora 9 Linux.
       Спасибо Roxis.


Изменения в rap 0.7.0                                           19.05.2008

    *) Изменение: теперь символы 0x00-0x1F, '"' и '\' в access_log
       записываются в виде \xXX.
       Спасибо Максиму Дунину.

    *) Изменение: теперь rap разрешает несколько строк "Host" в заголовке
       запроса.
...
Изменения в rap 0.6.31                                          12.05.2008

    *) Исправление: rap не обрабатывал ответ FastCGI-сервера, если строка
...
Изменения в rap 0.6.30                                          29.04.2008

    *) Изменение: теперь, если маске, заданной в директиве include, не
       соответствует ни один файл, то rap не выдаёт ошибку.
    ...
    *) Исправление: теперь при сборке с Cygwin rap всегда открывает файлы
       в бинарном режиме.

    *) Исправление: rap не собирался под OpenBSD; ошибка появилась в
       0.6.15.


Изменения в rap 0.6.29                                          18.03.2008

    *) Добавление: модуль rap_google_perftools_module.

    *) Исправление: модуль rap_http_perl_module не собирался на 64-битных
       платформах; ошибка появилась в 0.6.27.


Изменения в rap 0.6.28                                          13.03.2008

    *) Исправление: метод rtsig не собирался; ошибка появилась в 0.6.27.


Изменения в rap 0.6.27                                          12.03.2008
    ...
    *) Исправление: при перенаправлении ошибок 495-497 с помощью директивы
       error_page без изменения кода ошибки rap пытался выделить очень
       много памяти.
...
Изменения в rap 0.6.26                                          11.02.2008
    ...
    *) Исправление: rap неверно определял длину строки кэша на Pentium 4.
       Спасибо Геннадию Махомеду.
    ...
    *) Исправление: rap выдавал ошибочное сообщение "SSL_shutdown() failed
...
Изменения в rap 0.6.25                                          08.01.2008
    ...
    *) Исправление: модуль rap_http_gzip_static_module не позволял работать
       модулю rap_http_dav_module; ошибка появилась в 0.6.23.
...
Изменения в rap 0.6.23                                          27.12.2007
    ...
    *) Добавление: модуль rap_http_gzip_static_module.
...
Изменения в rap 0.6.22                                          19.12.2007

    *) Изменение: теперь все методы модуля rap_http_perl_module возвращают
       значения, скопированные в память, выделенную perl'ом.

    *) Исправление: если rap был собран с модулем rap_http_perl_module,
    ...
    *) Исправление: в методы модуля rap_http_perl_module могли передаваться
...
Изменения в rap 0.6.21                                          03.12.2007
    ...
    *) Исправление: если resolver использовался на платформах, не
       поддерживающих метод kqueue, то rap выдавал alert "name is out of
       response".
       Спасибо Андрею Нигматулину.
    ...
    *) Исправление: При использовании переменной $server_protocol в
       ...
       директивы client_header_buffer_size, rap выдавал alert "fastcgi:
       the request record is too big".

    *) Исправление: при обычном запросе версии HTTP/0.9 к HTTPS серверу
       rap возвращал обычный ответ.


Изменения в rap 0.6.20                                          28.11.2007
...
Изменения в rap 0.6.19                                          27.11.2007

    *) Исправление: версия 0.6.18 не собиралась.


Изменения в rap 0.6.18                                          27.11.2007

    *) Изменение: теперь модуль rap_http_userid_module в поле куки с номером
...
Изменения в rap 0.6.17                                          15.11.2007
...
Изменения в rap 0.6.16                                          29.10.2007
...
Изменения в rap 0.6.15                                          22.10.2007
    ...
    *) Исправление: rap не раскодировал URI в команде SSI include.
...
Изменения в rap 0.6.14                                          15.10.2007
    ...
    *) Исправление: при использовании переменных $date_local и $date_gmt вне
       модуля rap_http_ssi_filter_module в рабочем процессе происходил
       segmentation fault.
    ...
    *) Исправление: rap_http_memcached_module не устанавливал
    ...
    *) Исправление: rap распознавал параметры "close" и "keep-alive" в
...
Изменения в rap 0.6.13                                          24.09.2007

    *) Исправление: rap не закрывал файл каталога для запроса HEAD, если
       использовался autoindex
       Спасибо Arkadiusz Patyk.


Изменения в rap 0.6.12                                          21.09.2007
...
Изменения в rap 0.6.11                                          11.09.2007
    ...
    *) Исправление: если бэкенд возвращал только заголовок ответа при
       небуферизированном проксировании, то rap закрывал соединение с
       бэкендом по таймауту.

    *) Исправление: rap не поддерживал несколько строк "Connection" в
       заголовке запроса.
...
Изменения в rap 0.6.10                                          03.09.2007
...
Изменения в rap 0.6.9                                           28.08.2007

    *) Исправление: рабочий процесс мог зациклиться при использовании
       протокола HTTPS; ошибка появилась в 0.6.7.

    *) Исправление: если сервер слушал на двух адресах или портах, то rap
    ...
    *) Исправление: rap не собирался на amd64; ошибка появилась в 0.6.8.


Изменения в rap 0.6.8                                           20.08.2007

    *) Изменение: теперь rap пытается установить директивы
       worker_priority, worker_rlimit_nofile, worker_rlimit_core,
       worker_rlimit_sigpending без привилегий root'а.

    *) Изменение: теперь rap экранирует символы пробела и "%" при передаче
       запроса серверу аутентификации почтового прокси-сервера.

    *) Изменение: теперь rap экранирует символ "%" в переменной
       $memcached_key.

    *) Исправление: при указании относительного пути к конфигурационному
       файлу в качестве параметра ключа -c rap определял путь относительно
       конфигурационного префикса; ошибка появилась в 0.6.6.

    *) Исправление: rap не работал на FreeBSD/sparc64.


Изменения в rap 0.6.7                                           15.08.2007

    *) Изменение: теперь пути, указанные в директивах include,
       auth_basic_user_file, perl_modules, ssl_certificate,
       ssl_certificate_key и ssl_client_certificate, определяются
       относительно каталога конфигурационного файла rap.conf, а не
    ...
    *) Добавление: модуль rap_http_perl_module поддерживает метод
    ...
    *) Исправление: если на запрос с телом возвращался ответ с кодом HTTP
       ...
       состояние keep-alive, то на следующий запрос rap возвращал 400.

    *) Исправление: если в директиве auth_http был задан неправильный адрес,
       то в рабочем процессе происходил segmentation fault.

    *) Исправление: теперь по умолчанию rap использует значение 511 для
...
Изменения в rap 0.6.6                                           30.07.2007
    ...
    *) Исправление: если клиент в почтовом прокси-сервере закрывал
       соединение, то rap мог не закрывать соединение с бэкендом.

    *) Исправление: при использовании одного хоста в качестве бэкендов для
       протоколов HTTP и HTTPS без явного указания портов, rap использовал
       только один порт - 80 или 443.

    *) Исправление: rap не собирался на Solaris/amd64 Sun Studio 11 и
       более ранними версиями; ошибка появилась в 0.6.4.


Изменения в rap 0.6.5                                           23.07.2007

    *) Добавление: переменная $rap_version.
    ...
    *) Исправление: теперь rap экранирует пробел в переменной
       $memcached_key.

    *) Исправление: rap неправильно собирался Sun Studio на Solaris/amd64.
       Спасибо Jiang Hong.
...
Изменения в rap 0.6.4                                           17.07.2007
    ...
    *) Исправление: rap не работал на Solaris/sparc64, если был собран Sun
       Studio.
       Спасибо Андрею Нигматулину.
...
Изменения в rap 0.6.3                                           12.07.2007
...
Изменения в rap 0.6.2                                           09.07.2007

    *) Исправление: если заголовок ответа был разделён в FastCGI-записях, то
       rap передавал клиенту мусор в таких заголовках.


Изменения в rap 0.6.1                                           17.06.2007
    ...
    *) Исправление: значение perl'овой переменной $$ модуля
       rap_http_perl_module было равно номеру главного процесса.


Изменения в rap 0.6.0                                           14.06.2007

    *) Добавление: директивы "server_name", "map", and "valid_referers"
       поддерживают маски вида "www.example.*".


Изменения в rap 0.5.25                                          11.06.2007

    *) Исправление: rap не собирался с параметром
       --without-http_rewrite_module; ошибка появилась в 0.5.24.


Изменения в rap 0.5.24                                          06.06.2007
...
Изменения в rap 0.5.23                                          04.06.2007

    *) Добавление: модуль rap_http_ssl_module поддерживает расширение TLS
...
Изменения в rap 0.5.20                                          07.05.2007
    ...
    *) Исправление: модуль rap_http_perl_module не собирался make в Solaris.
       Спасибо Андрею Нигматулину.


Изменения в rap 0.5.19                                          24.04.2007

    *) Изменение: значение переменной $request_time теперь записывается с
       точностью до миллисекунд.

    *) Изменение: метод $r->rflush в модуле rap_http_perl_module
...
Изменения в rap 0.5.18                                          19.04.2007

    *) Добавление: модуль rap_http_sub_filter_module.
...
Изменения в rap 0.5.17                                          02.04.2007

    *) Изменение: теперь rap для метода TRACE всегда возвращает код 405.

    *) Добавление: теперь rap поддерживает директиву include внутри блока
       types.
...
Изменения в rap 0.5.16                                          26.03.2007
    ...
    *) Исправление: rap не собирался на Solaris без параметра
       --with-debug; ошибка появилась в 0.5.15.


Изменения в rap 0.5.15                                          19.03.2007
    ...
    *) Исправление: при использовании директивы starttls only в протоколе
       POP3 rap разрешал аутентификацию без перехода в режим SSL.
    ...
    *) Исправление: теперь rap не пишет в лог некоторые alert'ы, если
       используются методы eventport или /dev/poll.


Изменения в rap 0.5.14                                          23.02.2007

    *) Исправление: rap игнорировал лишние закрывающие скобки "}" в конце
       конфигурационного файла.


Изменения в rap 0.5.13                                          19.02.2007

    *) Добавление: методы COPY и MOVE.

    *) Исправление: модуль rap_http_realip_module устанавливал мусор для
       запросов, переданных по keep-alive соединению.

    *) Исправление: rap не работал на 64-битном big-endian Linux.
       Спасибо Андрею Нигматулину.
    ...
    *) Исправление: если при использовании метода epoll клиент закрывал
       преждевременно соединение со своей стороны, то rap закрывал это
...
Изменения в rap 0.5.12                                          12.02.2007
    ...
    *) Исправление: rap_http_perl_module не собирался на Solaris.


Изменения в rap 0.5.11                                          05.02.2007
...
Изменения в rap 0.5.10                                          26.01.2007
...
Изменения в rap 0.5.9                                           25.01.2007

    *) Изменение: модуль rap_http_memcached_module теперь в качестве ключа
    ...
    *) Добавление: теперь при ошибке записи в access_log rap записывает
...
Изменения в rap 0.5.8                                           19.01.2007
...
Изменения в rap 0.5.7                                           15.01.2007
...
Изменения в rap 0.5.6                                           09.01.2007

    *) Изменение: теперь модуль rap_http_index_module игнорирует все методы,
       кроме GET, HEAD и POST.

    *) Добавление: модуль rap_http_limit_zone_module.

    *) Добавление: переменная $binary_remote_addr.

    *) Добавление: директивы ssl_session_cache модулей rap_http_ssl_module и
       rap_imap_ssl_module.
...
Изменения в rap 0.5.5                                           24.12.2006
    ...
    *) Исправление: модуль rap.pm теперь может устанавливаться
...
Изменения в rap 0.5.2                                           11.12.2006

    *) Исправление: если в директивах proxy_pass использовалось имя,
       указанное в upstream, то rap пытался найти IP-адрес этого имени;
       ошибка появилась в 0.5.1.


Изменения в rap 0.5.1                                           11.12.2006
    ...
    *) Исправление: rap_http_auth_basic_module игнорировал пользователя,
...
Изменения в rap 0.5.0                                           04.12.2006
...
Изменения в rap 0.4.14                                          27.11.2006
    ...
    *) Исправление: rap_http_perl_module не работал с перлом, собранным с
       поддержкой потоков; ошибка появилась в 0.3.38.

    *) Исправление: rap_http_perl_module не работал корректно, если перл
       вызывался рекурсивно.

    *) Исправление: rap игнорировал имя сервера в строке запроса.
...
Изменения в rap 0.4.13                                          15.11.2006
    ...
    *) Исправление: для ответов модуля rap_http_autoindex_module не
...
Изменения в rap 0.4.12                                          31.10.2006
    ...
    *) Исправление: rap не убирал "#fragment" в URI.


Изменения в rap 0.4.11                                          25.10.2006
...
Изменения в rap 0.4.10                                          23.10.2006
    ...
    *) Исправление: модуль rap_http_flv_module не поддерживал byte ranges
       для полных ответов; ошибка появилась в 0.4.7.

    *) Исправление: rap не собирался на Debian amd64; ошибка появилась в
       0.4.9.


Изменения в rap 0.4.9                                           13.10.2006

    *) Добавление: параметр set в команде SSI include.

    *) Добавление: модуль rap_http_perl_module теперь проверяет версию
       модуля rap.pm.


Изменения в rap 0.4.8                                           11.10.2006
    ...
    *) Исправление: модуль rap_http_flv_module добавлял FLV-заголовок для
       полных ответов.
       Спасибо Алексею Ковырину.


Изменения в rap 0.4.7                                           10.10.2006

    *) Добавление: модуль rap_http_flv_module.
    ...
    *) Исправление: rap не запускался на 64-битных платформах, отличных от
       amd64, sparc64 и ppc64.


Изменения в rap 0.4.6                                           06.10.2006

    *) Исправление: rap не запускался на 64-битных платформах, отличных от
       amd64, sparc64 и ppc64.

    *) Исправление: при запросе версии HTTP/1.1 rap передавал ответ
    ...
    *) Исправление: после перенаправления ошибки с помощью директивы
       error_page любая директива модуля rap_http_rewrite_module возвращала
       эту ошибку; ошибка появилась в 0.4.4.


Изменения в rap 0.4.5                                           02.10.2006

    *) Исправление: rap не собирался на Linux и Solaris; ошибка появилась
       в 0.4.4.


Изменения в rap 0.4.4                                           02.10.2006
...
Изменения в rap 0.4.3                                           26.09.2006
    ...
    *) Добавление: модуль rap_http_browser_module.
...
Изменения в rap 0.4.2                                           14.09.2006

    *) Исправление: убрана поддержка флага O_NOATIME на Linux; ошибка
       появилась в 0.4.1.


Изменения в rap 0.4.1                                           14.09.2006
    ...
    *) Добавление: теперь на Linux rap для статических запросов использует
       флаг O_NOATIME.
       Спасибо Yusuf Goolamabbas.


Изменения в rap 0.4.0                                           30.08.2006

    *) Изменение во внутреннем API: инициализация модулей HTTP перенесена из
       фазы init module в фазу HTTP postconfiguration.

    *) Изменение: теперь тело запроса в модуле rap_http_perl_module не
       считывается заранее: нужно явно инициировать чтение с помощью метода
       $r->has_request_body.

    *) Добавление: модуль rap_http_perl_module поддерживает код возврата
       DECLINED.

    *) Добавление: модуль rap_http_dav_module поддерживает входящую строку
...
Изменения в rap 0.3.61                                          28.08.2006
...
Изменения в rap 0.3.58                                          14.08.2006
    ...
    *) Исправление: rap не запускался на 64-битной FreeBSD 7.0-CURRENT.


Изменения в rap 0.3.57                                          09.08.2006
    ...
    *) Исправление: при проверке клиентского сертификата rap не передавал
...
Изменения в rap 0.3.56                                          04.08.2006
...
Изменения в rap 0.3.55                                          28.07.2006

    *) Добавление: параметр stub в команде SSI include.

    *) Добавление: команда SSI block.

    *) Добавление: скрипт unicode2rap добавлен в contrib.
    ...
    *) Исправление: метод $r->header_in("Cookie") модуля
       rap_http_perl_module теперь возвращает все строки "Cookie" в
       заголовке запроса.
...
Изменения в rap 0.3.54                                          11.07.2006

    *) Добавление: rap теперь записывает в лог информацию о подзапросах.
    ...
    *) Исправление: rap не собирался на платформе amd64; ошибка появилась
       в 0.3.53.


Изменения в rap 0.3.53                                          07.07.2006
    ...
    *) Добавление: rap поддерживает тело запроса больше 2G.
    ...
    *) Исправление: если во время аутентификации IMAP/POP3 бэкенд возвращал
       ошибку, rap продолжал проксирование.


Изменения в rap 0.3.52                                          03.07.2006

    *) Изменение: восстановлено поведение модуля rap_http_index_module для
    ...
    *) Исправление: модуль rap_http_charset_module записывал в лог ошибку
...
Изменения в rap 0.3.51                                          30.06.2006

    *) Исправление: при некоторых условиях в SSI мог пропадать символы "<";
       ошибка появилась в 0.3.50.


Изменения в rap 0.3.50                                          28.06.2006
    ...
    *) Добавление: модуль rap_http_charset_module поддерживает
...
Изменения в rap 0.3.49                                          31.05.2006
...
Изменения в rap 0.3.48                                          29.05.2006

    *) Изменение: теперь модуль rap_http_charset_module работает для
    ...
    *) Исправление: модуль rap_http_perl_module не собирался, если перл был
       с поддержкой потоков; ошибка появилась в 0.3.46.


Изменения в rap 0.3.47                                          23.05.2006
...
Изменения в rap 0.3.46                                          11.05.2006
...
Изменения в rap 0.3.45                                          06.05.2006
    ...
    *) Исправление: если rap распределял запросы на несколько машин, то
...
Изменения в rap 0.3.44                                          04.05.2006
...
Изменения в rap 0.3.43                                          26.04.2006

    *) Исправление: в SSI.


Изменения в rap 0.3.42                                          26.04.2006
...
Изменения в rap 0.3.41                                          21.04.2006
...
Изменения в rap 0.3.40                                          19.04.2006

    *) Добавление: модуль rap_http_dav_module поддерживает метод MKCOL.
...
Изменения в rap 0.3.39                                          17.04.2006
...
Изменения в rap 0.3.38                                          14.04.2006

    *) Добавление: модуль rap_http_dav_module.

    *) Изменение: оптимизация модуля rap_http_perl_module.
...
Изменения в rap 0.3.37                                          07.04.2006
    ...
    *) Исправление: в модуле rap_http_addition_filter_module.


Изменения в rap 0.3.36                                          05.04.2006

    *) Добавление: модуль rap_http_addition_filter_module.
    ...
    *) Добавление: модуль rap_http_ssi_module поддерживает команду elif.

    *) Исправление: строка "\/" в начале выражения команды if модуля
       rap_http_ssi_module воспринималась неверно.

    *) Исправление: в использовании регулярных выражениях в команде if
       модуля rap_http_ssi_module.
...
Изменения в rap 0.3.35                                          22.03.2006
...
Изменения в rap 0.3.30                                          22.02.2006

    *) Изменение: уровень записи в лог ошибки ECONNABORTED изменён на error
       с уровня crit.

    *) Исправление: модуль rap_http_perl_module не собирался без модуля
       rap_http_ssi_filter_module.

    *) Исправление: rap не собирался на i386 платформе, если использовался
       PIC; ошибка появилась в 0.3.27.


Изменения в rap 0.3.29                                          20.02.2006

    *) Добавление: теперь rap использует меньше памяти, если PHP в режиме
    ...
    *) Исправление: rap возвращал 502 код ответа, если FastCGI сервер
...
Изменения в rap 0.3.28                                          16.02.2006
...
Изменения в rap 0.3.27                                          08.02.2006
...
Изменения в rap 0.3.26                                          03.02.2006
...
Изменения в rap 0.3.25                                          01.02.2006
...
Изменения в rap 0.3.24                                          01.02.2006
...
Изменения в rap 0.3.23                                          24.01.2006
    ...
    *) Исправление: модуль rap_http_perl_module неправильно собирался на
       Linux и Solaris.


Изменения в rap 0.3.22                                          17.01.2006

    *) Добавление: модуль rap_http_perl_module поддерживает методы $r->args
       и $r->unescape.

    *) Добавление: метод $r->query_string в модуле rap_http_perl_module
       упразднён.
...
Изменения в rap 0.3.21                                          16.01.2006

    *) Добавление: модуль rap_http_perl_module.

    *) Изменение: директива valid_referers разрешает использовать рефереры
       совсем без URI.


Изменения в rap 0.3.20                                          11.01.2006

    *) Исправление: ошибки в обработке SSI.

    *) Исправление: модуль rap_http_memcached_module не поддерживал ключи в
       виде /uri?args.


Изменения в rap 0.3.19                                          28.12.2005
...
Изменения в rap 0.3.18                                          26.12.2005
    ...
    *) Исправление: некоторые имена вида ".domain.tld" неверно
       обрабатывались модулем rap_http_map_module.
...
Изменения в rap 0.3.17                                          18.12.2005
...
Изменения в rap 0.3.16                                          16.12.2005

    *) Добавление: модуль rap_http_map_module.
    ...
    *) Исправление: rap не закрывал соединения с IMAP/POP3 бэкендом при
...
Изменения в rap 0.3.12                                          26.11.2005

    *) Безопасность: если rap был собран с модулем rap_http_realip_module,
       то при использовании директивы "satisfy_any on" директивы доступа и
       аутентификации не работали. Модуль rap_http_realip_module не
    ...
    *) Добавление: модуль rap_http_memcached_module.
    ...
    *) Исправление: если клиент передал строку "Transfer-Encoding: chunked"
       в заголовке запроса, то rap теперь выдаёт ошибку 411.
    ...
    *) Исправление: rap не работал на платформе sparc под любыми OS, кроме
       Solaris.
...
Изменения в rap 0.3.11                                          15.11.2005

    *) Исправление: rap не передавал при проксировании тело запроса и
       строки заголовка клиента; ошибка появилась в 0.3.10.


Изменения в rap 0.3.10                                          15.11.2005

    *) Изменение: директива valid_referers и переменная $invalid_referer
       перенесены из модуля rap_http_rewrite_module в новый модуль
       rap_http_referer_module.
    ...
    *) Добавление: модуль rap_http_empty_gif_module.
    ...
    *) Исправление: rap не собирался компилятором icc 9.0.
...
Изменения в rap 0.3.9                                           10.11.2005

    *) Исправление: rap считал небезопасными URI, в которых между двумя
       слэшами находилось два любых символа; ошибка появилась в 0.3.8.


Изменения в rap 0.3.8                                           09.11.2005

    *) Безопасность: rap теперь проверят URI, полученные от бэкенда в
       строке "X-Accel-Redirect" в заголовке ответа, или в SSI файле на
       наличие путей "/../" и нулей.

    *) Изменение: rap теперь не воспринимает пустое имя как правильное в
       строке "Authorization" в заголовке запроса.

    *) Добавление: директива ssl_session_timeout модулей rap_http_ssl_module
       и rap_imap_ssl_module.

    *) Добавление: директива auth_http_header модуля
       rap_imap_auth_http_module.

    *) Добавление: директива add_header.

    *) Добавление: модуль rap_http_realip_module.
    ...
    *) Исправление: при работает с проксированными или FastCGI-серверами
       rap мог оставлять открытыми соединения и временные файлы с
       запросами клиентов.
    ...
    *) Исправление: при использовании метода rtsig и нескольких рабочих
       процессах rap мог перестать принимать запросы.
...
Изменения в rap 0.3.7                                           27.10.2005
...
Изменения в rap 0.3.6                                           24.10.2005
    ...
    *) Исправление: если хотя бы в одном сервере не было описано ни одной
       директивы listen, то rap не слушал на 80 порту; ошибка появилась в
       0.3.3.
...
Изменения в rap 0.3.5                                           21.10.2005
...
Изменения в rap 0.3.4                                           19.10.2005

    *) Исправление: rap не собирался на Linux 2.4+ и MacOS X; ошибка
       появилась в 0.3.3.


Изменения в rap 0.3.3                                           19.10.2005
    ...
    *) Исправление: если в директиве listen был указан неверный адрес, то
       rap после сигнала -HUP оставлял открытый сокет в состоянии CLOSED.
...
Изменения в rap 0.3.1                                           10.10.2005
...
Изменения в rap 0.3.0                                           07.10.2005
...
Изменения в rap 0.2.6                                           05.10.2005
    ...
    *) Исправление: если после изменения URI в блоке if для запроса не
       ...
       rap_http_rewrite_module выполнялись снова.

    *) Исправление: если директива set устанавливала переменную модуля
       rap_http_geo_module в какой-либо части конфигурации, то эта
...
Изменения в rap 0.2.5                                           04.10.2005

    *) Изменение: дублирующее значение переменной модуля rap_http_geo_module
       теперь выдаёт предупреждение и изменяет старое значение.

    *) Добавление: модуль rap_http_ssi_module поддерживает команду set.

    *) Добавление: модуль rap_http_ssi_module поддерживает параметр file в
       команде include.

    *) Добавление: модуль rap_http_ssi_module поддерживает подстановку
       значений переменных в выражениях команды if.


Изменения в rap 0.2.4                                           03.10.2005

    *) Добавление: модуль rap_http_ssi_module поддерживает выражения
...
Изменения в rap 0.2.3                                           30.09.2005

    *) Исправление: rap не собирался без параметра --with-debug; ошибка
       появилась в 0.2.2.


Изменения в rap 0.2.2                                           30.09.2005

    *) Добавление: команда config errmsg в модуле rap_http_ssi_module.

    *) Изменение: переменные модуля rap_http_geo_module можно переопределять
       директивой set.

    *) Добавление: директивы ssl_protocols и ssl_prefer_server_ciphers
       модулей rap_http_ssl_module и rap_imap_ssl_module.

    *) Исправление: ошибка в модуле rap_http_autoindex_module при показе
       длинных имён файлов;

    *) Исправление: модуль rap_http_autoindex_module теперь не показывает
...
Изменения в rap 0.2.1                                           23.09.2005
    ...
    *) Исправление: если все бэкенды, используемые для балансировки
       ...
       rap мог зациклится; ошибка появилась в 0.2.0.


Изменения в rap 0.2.0                                           23.09.2005
    ...
    *) Изменение: модули rap_http_access_module и rap_http_auth_basic_module
    ...
    *) Исправление: если все бэкенды, используемые для балансировки
       нагрузки, оказывались в нерабочем состоянии после одной ошибки, то
       rap не обращался к ним в течение 60 секунд.
...
Изменения в rap 0.1.45                                          08.09.2005

    *) Изменение: директива ssl_engine упразднена в модуле
       rap_http_ssl_module и перенесена на глобальный уровень.
...
Изменения в rap 0.1.44                                          06.09.2005

    *) Добавление: IMAP/POP3 прокси поддерживает SSL.

    *) Добавление: директива proxy_timeout модуля rap_imap_proxy_module.
...
Изменения в rap 0.1.43                                          30.08.2005

    *) Добавление: listen(2) backlog в директиве listen можно менять по
       сигналу -HUP.

    *) Добавление: скрипт geo2rap.pl добавлен в contrib.
...
Изменения в rap 0.1.42                                          23.08.2005

    *) Исправление: если URI запроса получался нулевой длины после обработки
       модулем rap_http_rewrite_module, то в модуле rap_http_proxy_module
...
Изменения в rap 0.1.39                                          14.07.2005

    *) Изменения в модуле rap_http_charset_module: директива default_charset
    ...
    *) Исправление: модули rap_http_proxy_module и rap_http_fastcgi_module
    ...
    *) Исправление: модуль rap_http_ssi_module не поддерживал относительные
       URI в команде include virtual.

    *) Исправление: если в строке заголовка ответа бэкенда была строка
       "Location", которую rap не должен был изменять, то в ответе
       передавалось тело 500 ошибки; ошибка появилась в 0.1.29.

    *) Исправление: некоторые директивы модулей rap_http_proxy_module и
       rap_http_fastcgi_module не наследовались с уровня server на уровень
       location; ошибка появилась в 0.1.29.

    *) Исправление: модуль rap_http_ssl_module не поддерживал цепочки
       сертификатов.
...
Изменения в rap 0.1.38                                          08.07.2005
    ...
    *) Исправление: если статусная строка в ответе бэкенда передавалась в
       двух пакетах, то rap считал ответ неверным; ошибка появилась в
       0.1.29.
    ...
    *) Исправление: модуль rap_http_autoindex_module не поддерживал длинные
       имена файлов в UTF-8.

    *) Добавление: IMAP/POP3 прокси.


Изменения в rap 0.1.37                                          23.06.2005

    *) Изменение: в конце файла rap.pid теперь добавляется "\n".
    ...
    *) Исправление: если все бэкенды возвращали ответ 404, то при
       ...
       fastcgi_next_upstream, rap начинал запрашивать все бэкенды снова.


Изменения в rap 0.1.36                                          15.06.2005

    *) Изменение: если в заголовке запроса есть дублирующиеся строки "Host",
       "Connection", "Content-Length" и "Authorization", то rap теперь
       выдаёт ошибку 400.
    ...
    *) Исправление: модуль rap_http_autoindex_module не поддерживал имена
       файлов в UTF-8.

    *) Исправление: после добавления новый лог-файл ротация этого лога по
       сигналу -USR1 выполнялась, только если переконфигурировать rap два
       раза по сигналу -HUP.


Изменения в rap 0.1.35                                          07.06.2005
...
Изменения в rap 0.1.34                                          26.05.2005
...
Изменения в rap 0.1.33                                          23.05.2005
...
Изменения в rap 0.1.32                                          19.05.2005
...
Изменения в rap 0.1.31                                          16.05.2005
...
Изменения в rap 0.1.30                                          14.05.2005
    ...
    *) Исправление: если длина части ответа, полученного за один раз от
       проксируемого или FastCGI сервера была равна 500 байт, то rap
       возвращал код ответа 500; в режиме прокси ошибка появилась только в
       0.1.29.

    *) Исправление: rap не считал неверными директивы с 8-ю или 9-ю
       параметрами.
...
Изменения в rap 0.1.29                                          12.05.2005

    *) Добавление: модуль rap_http_ssi_module поддерживает команду include
       virtual.

    *) Добавление: модуль rap_http_ssi_module поддерживает условную команду
       вида 'if expr="$NAME"' и команды else и endif. Допускается только
       один уровень вложенности.

    *) Добавление: модуль rap_http_ssi_module поддерживает две переменные
    ...
    *) Изменение: модуль rap_http_proxy_module полностью переписан.
    ...
    *) Изменение: rap теперь передаёт неверные строки в заголовках запроса
    ...
    *) Исправление: rap не учитывал завершающую точку в строке заголовка
       запроса "Host".

    *) Исправление: модуль rap_http_auth_module не работал на Linux.

    *) Исправление: директива rewrite неверно работала, если в запросе
       присутствовали аргументы.

    *) Исправление: rap не собирался на MacOS X.


Изменения в rap 0.1.28                                          08.04.2005

    *) Исправление: при проксировании больших файлов rap сильно нагружал
       процессор.

    *) Исправление: rap не собирался gcc 4.0 на Linux.


Изменения в rap 0.1.27                                          28.03.2005
    ...
    *) Исправление: rap не собирался на FreeBSD и Linux, если был указан
       параметр конфигурации --without-rap_http_auth_basic_module.


Изменения в rap 0.1.26                                          22.03.2005
    ...
    *) Добавление: модуль rap_http_auth_basic_module и директивы auth_basic
       и auth_basic_user_file.


Изменения в rap 0.1.25                                          19.03.2005

    *) Исправление: rap не работал на Linux parisc.

    *) Добавление: rap теперь не запускается под FreeBSD, если значение
       sysctl kern.ipc.somaxconn слишком большое.

    *) Исправление: если модуль rap_http_index_module делал внутреннее
       перенаправление запроса в модули rap_http_proxy_module или
       rap_http_fastcgi_module, то файл индекса не закрывался после
       обслуживания запроса.

    *) Добавление: директива proxy_pass может использоваться в location,
       заданных регулярным выражением.

    *) Добавление: модуль rap_http_rewrite_filter_module поддерживает
       условия вида "if ($HTTP_USER_AGENT ~ MSIE)".

    *) Исправление: rap очень медленно запускался при большом количестве
...
Изменения в rap 0.1.24                                          04.03.2005

    *) Добавление: модуль rap_http_ssi_filter_module поддерживает переменные
       QUERY_STRING и DOCUMENT_URI.

    *) Исправление: модуль rap_http_autoindex_module мог выдавать ответ 404
       на существующий каталог, если этот каталог был указан как alias.

    *) Исправление: модуль rap_http_ssi_filter_module неправильно работал
       при больших ответах.
...
Изменения в rap 0.1.23                                          01.03.2005

    *) Добавление: модуль rap_http_ssi_filter_module и директивы ssi,
    ...
    *) Исправление: модуль rap_http_autoindex_module теперь показывает
...
Изменения в rap 0.1.22                                          22.02.2005

    *) Исправление: модуль rap_http_stub_status_module показывал неверную
...
Изменения в rap 0.1.21                                          22.02.2005

    *) Исправление: модуль rap_http_stub_status_module показывал неверную
       статистику при использовании метода rtsig или при использовании
       нескольких рабочих процессов на SMP машине.

    *) Исправление: rap не собирался компилятором icc под Линуксом или
       если библиотека zlib-1.2.x собиралась из исходных текстов.

    *) Исправление: rap не собирался под NetBSD 2.0.


Изменения в rap 0.1.20                                          17.02.2005
...
Изменения в rap 0.1.19                                          16.02.2005
...
Изменения в rap 0.1.18                                          09.02.2005
    ...
    *) Исправление: строки для модуля rap_http_geo_module без символа ";" во
       включённом файле игнорировались.

    *) Добавление: модуль rap_http_stub_status_module.
...
Изменения в rap 0.1.17                                          03.02.2005

    *) Изменение: модуль rap_http_rewrite_module полностью переписан. Теперь
    ...
    *) Добавление: модуль rap_http_geo_module.
...
Изменения в rap 0.1.16                                          25.01.2005
    ...
    *) Исправление: ошибки в модуле rap_http_fastcgi_module вызывали
       segmentation fault.
...
Изменения в rap 0.1.15                                          19.01.2005
    ...
    *) Исправление: для использования регулярных выражений в location нужно
       было собирать rap вместе с rap_http_rewrite_module.
...
Изменения в rap 0.1.14                                          18.01.2005
    ...
    *) Добавление: модуль rap_http_fastcgi_module и директивы fastcgi_pass,
...
Изменения в rap 0.1.13                                          21.12.2004
...
Изменения в rap 0.1.12                                          06.12.2004
...
Изменения в rap 0.1.11                                          02.12.2004
    ...
    *) Исправление: rap не вызывал initgroups().
       Спасибо Андрею Ситникову и Андрею Нигматулину.

    *) Изменение: rap_http_auto_index_module теперь выдаёт размер файлов в
       байтах.

    *) Исправление: rap_http_auto_index_module возвращал ошибку 500, если в
    ...
    *) Исправление: rap не собирался под OpenBSD.

    *) Исправление: двойные слэшы в "://" в URI превращались в ":/".


Изменения в rap 0.1.10                                          26.11.2004
...
Изменения в rap 0.1.9                                           25.11.2004
...
Изменения в rap 0.1.8                                           20.11.2004
...
Изменения в rap 0.1.7                                           12.11.2004
...
Изменения в rap 0.1.6                                           11.11.2004
...
Изменения в rap 0.1.5                                           11.11.2004
    ...
    *) Исправление: в списке файлов, выдаваемом модулем
       rap_http_autoindex_module, не перекодировались пробелы, кавычки и
       знаки процента.
...
Изменения в rap 0.1.4                                           26.10.2004

    *) Исправление: ошибка в модуле rap_http_autoindex_module.


Изменения в rap 0.1.3                                           25.10.2004

    *) Добавление: модуль rap_http_autoindex_module и директива autoindex.
...
Изменения в rap 0.1.2                                           21.10.2004
    ...
    *) Исправление: нельзя переконфигурировать rap, если конфигурационный
...
Изменения в rap 0.1.1                                           11.10.2004
    ...
    *) Исправление: ошибка в модуле rap_http_chunked_module, приводившая к
       зацикливанию.
...
Изменения в rap 0.1.0                                           04.10.2004
