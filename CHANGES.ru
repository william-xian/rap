...
Изменения в rap 1.17.9                                          03.03.2020
    ...
    *) Исправление: в модуле rp_http_mp4_module.
...
Изменения в rap 1.17.7                                          24.12.2019
    ...
    *) Исправление: в модуле rp_http_dav_module.
...
Изменения в rap 1.17.2                                          23.07.2019
    ...
    *) Исправление: в модуле rp_http_xslt_filter_module.

    *) Исправление: в модуле rp_http_ssi_filter_module.
...
Изменения в rap 1.15.8                                          25.12.2018
    ...
    *) Исправление: в модуле rp_http_autoindex_module на 32-битных
       платформах.
...
Изменения в rap 1.15.7                                          27.11.2018
    ...
    *) Исправление: в рабочем процессе мог произойти segmentation fault,
       если использовался модуль rp_http_mp4_module на 32-битных
       платформах.
...
Изменения в rap 1.15.6                                          06.11.2018
    ...
    *) Безопасность: при обработке специально созданного mp4-файла модулем
       rp_http_mp4_module содержимое памяти рабочего процесса могло быть
...
Изменения в rap 1.15.4                                          25.09.2018
    ...
    *) Исправление: в модуле rp_http_uwsgi_module.
    ...
    *) Исправление: стандартные сообщения об ошибках и ответы модуля
       rp_http_autoindex_module содержали атрибут bgcolor, что могло
...
Изменения в rap 1.15.3                                          28.08.2018
    ...
    *) Исправление: модуль rp_http_dav_module при копировании файла поверх
       существующего файла с помощью метода COPY не обнулял целевой файл.

    *) Исправление: модуль rp_http_dav_module при перемещении файла между
    ...
    *) Исправление: модуль rp_http_dav_module при копировании файла с
...
Изменения в rap 1.13.10                                         20.03.2018
    ...
    *) Добавление: модуль rp_http_grpc_module.
...
Изменения в rap 1.13.9                                          20.02.2018
    ...
    *) Исправление: в модуле rp_http_v2_module.
...
Изменения в rap 1.13.8                                          26.12.2017
    ...
    *) Исправление: модуль rp_http_autoindex_module неправильно обрабатывал
       запросы с телом.
...
Изменения в rap 1.13.7                                          21.11.2017
    ...
    *) Исправление: в модуле rp_http_fastcgi_module.
...
Изменения в rap 1.13.4                                          08.08.2017
    ...
    *) Добавление: модуль rp_http_mirror_module.
...
Изменения в rap 1.11.13                                         04.04.2017
    ...
    *) Исправление: в модуле rp_http_slice_module.
...
Изменения в rap 1.11.10                                         14.02.2017
    ...
    *) Исправление: модуль rp_http_slice_module не работал в именованных
       location'ах.
...
Изменения в rap 1.11.8                                          27.12.2016
    ...
    *) Исправление: в модуле rp_stream_ssl_preread_module.
...
Изменения в rap 1.11.7                                          13.12.2016
    ...
    *) Исправление: в модуле rp_http_perl_module.
...
Изменения в rap 1.11.6                                          15.11.2016
    ...
    *) Добавление: поддержка WebP в модуле rp_http_image_filter_module.

    *) Добавление: директива proxy_method поддерживает переменные.
       Спасибо Дмитрию Лазуркину.

    *) Добавление: директива http2_max_requests в модуле rp_http_v2_module.
...
Изменения в rap 1.11.5                                          11.10.2016
    ...
    *) Добавление: модуль rp_stream_ssl_preread_module.
...
Изменения в rap 1.11.4                                          13.09.2016
    ...
    *) Добавление: модуль rp_stream_log_module.
    ...
    *) Добавление: модуль rp_stream_realip_module.

    *) Исправление: rap не собирался с модулем stream и модулем
       rp_http_ssl_module, но без модуля rp_stream_ssl_module; ошибка
       появилась в 1.11.3.
...
Изменения в rap 1.11.3                                          26.07.2016
    ...
    *) Добавление: модуль rp_stream_geo_module.

    *) Добавление: модуль rp_stream_geoip_module.

    *) Добавление: модуль rp_stream_split_clients_module.
...
Изменения в rap 1.11.2                                          05.07.2016
    ...
    *) Добавление: модуль rp_stream_map_module.

    *) Добавление: модуль rp_stream_return_module.
...
Изменения в rap 1.11.0                                          24.05.2016
    ...
    *) Добавление: модуль rp_http_realip_module теперь позволяет
...
Изменения в rap 1.9.13                                          29.03.2016
    ...
    *) Добавление: модуль rp_http_perl_module теперь можно собрать
       динамически.
    ...
    *) Исправление: в модуле rp_http_sub_filter_module.
...
Изменения в rap 1.9.8                                           08.12.2015
    ...
    *) Добавление: модуль rp_http_slice_module.
...
Изменения в rap 1.9.7                                           17.11.2015
    ...
    *) Исправление: если rap был собран с модулем rp_http_v2_module,
...
Изменения в rap 1.9.5                                           22.09.2015
    ...
    *) Добавление: модуль rp_http_v2_module (заменяет модуль
       rp_http_spdy_module).
...
Изменения в rap 1.7.12                                          07.04.2015
    ...
    *) Исправление: в модуле rp_http_spdy_module.
...
Изменения в rap 1.7.5                                           16.09.2014
    ...
    *) Исправление: в модуле rp_http_spdy_module при использовании
       совместно с AIO.
...
Изменения в rap 1.7.3                                           08.07.2014
    ...
    *) Исправление: в модуле rp_http_dav_module в rap/Windows.
...
Изменения в rap 1.5.13                                          08.04.2014
    ...
    *) Добавление: модуль rp_http_mp4_module теперь понимает аргумент end.

    *) Добавление: поддержка byte ranges модулем rp_http_mp4_module и при
       сохранении ответов в кэш.

    *) Исправление: теперь rap не пишет в лог сообщения "rp_slab_alloc()
       failed: no memory" при использовании разделяемой памяти в
       ssl_session_cache и в модуле rp_http_limit_req_module.
...
Изменения в rap 1.5.12                                          18.03.2014
    ...
    *) Безопасность: при обработке специально созданного запроса модулем
       rp_http_spdy_module могло происходить переполнение буфера в рабочем
...
Изменения в rap 1.5.11                                          04.03.2014
    ...
    *) Безопасность: при обработке специально созданного запроса модулем
       rp_http_spdy_module на 32-битных платформах могла повреждаться
    ...
    *) Исправление: в рабочем процессе мог произойти segmentation fault,
       если использовался модуль rp_http_spdy_module на 32-битных
...
Изменения в rap 1.5.10                                          04.02.2014
    ...
    *) Добавление: модуль rp_http_spdy_module теперь использует протокол
       SPDY 3.1.
       Спасибо Automattic и MaxCDN за спонсирование разработки.

    *) Добавление: модуль rp_http_mp4_module теперь пропускает дорожки,
    ...
    *) Исправление: переменные $date_local и $date_gmt использовали неверный
       формат вне модуля rp_http_ssi_filter_module.
...
Изменения в rap 1.5.9                                           22.01.2014
    ...
    *) Исправление: модуль rp_http_dav_module не раскодировал целевой URI
    ...
    *) Исправление: в рабочем процессе мог произойти segmentation fault,
       если использовался модуль rp_http_spdy_module.
...
Изменения в rap 1.5.8                                           17.12.2013
    ...
    *) Добавление: поддержка SSL в модуле rp_http_uwsgi_module.
...
Изменения в rap 1.5.7                                           19.11.2013
    ...
    *) Исправление: ответы могли зависать, если использовался модуль
       rp_http_spdy_module и директива auth_request.
...
Изменения в rap 1.5.6                                           01.10.2013
    ...
    *) Исправление: в модуле rp_http_auth_basic_module при использовании
...
Изменения в rap 1.5.4                                           27.08.2013
    ...
    *) Добавление: модуль rp_http_auth_request_module.
    ...
    *) Исправление: в модуле rp_http_autoindex_module.
...
Изменения в rap 1.5.3                                           30.07.2013
    ...
    *) Исправление: в рабочем процессе мог произойти segmentation fault,
       если использовался модуль rp_http_spdy_module и директива
...
Изменения в rap 1.5.1                                           04.06.2013
    ...
    *) Исправление: rap не собирался с модулем rp_mail_ssl_module, но без
       модуля rp_http_ssl_module; ошибка появилась в 1.3.14.
...
Изменения в rap 1.4.0                                           24.04.2013
    ...
    *) Исправление: rap не собирался с модулем rp_http_perl_module, если
       использовался параметр --with-openssl; ошибка появилась в 1.3.16.

    *) Исправление: в работе с телом запроса из модуля rp_http_perl_module;
       ошибка появилась в 1.3.9.
...
Изменения в rap 1.3.15                                          26.03.2013
    ...
    *) Добавление: модуль rp_http_spdy_module.
...
Изменения в rap 1.3.14                                          05.03.2013
    ...
    *) Добавление: переменные $connections_active, $connections_reading и
       $connections_writing в модуле rp_http_stub_status_module.

    *) Добавление: поддержка WebSocket-соединений в модулях
       rp_http_uwsgi_module и rp_http_scgi_module.
...
Изменения в rap 1.3.12                                          05.02.2013
    ...
    *) Добавление: поддержка IPv6 в модуле rp_http_geoip_module.
...
Изменения в rap 1.3.10                                          25.12.2012
    ...
    *) Исправление: в рабочем процессе мог произойти segmentation fault,
       если использовался модуль rp_http_xslt_module.
...
Изменения в rap 1.3.8                                           30.10.2012
    ...
    *) Исправление: в модуле rp_http_gunzip_filter_module.
...
Изменения в rap 1.3.6                                           12.09.2012
    ...
    *) Добавление: модуль rp_http_gunzip_filter_module.
...
Изменения в rap 1.3.5                                           21.08.2012
    ...
    *) Изменение: модуль rp_http_mp4_module больше не отфильтровывает
...
Изменения в rap 1.3.2                                           26.06.2012
    ...
    *) Исправление: в рабочем процессе мог произойти segmentation fault,
       если использовался модуль rp_http_mp4_module.
...
Изменения в rap 1.3.1                                           05.06.2012
    ...
    *) Исправление: rap не собирался с модулем rp_cpp_test_module; ошибка
       появилась в 1.1.12.
...
Изменения в rap 1.1.19                                          12.04.2012
    ...
    *) Безопасность: при обработке специально созданного mp4 файла модулем
       rp_http_mp4_module могли перезаписываться области памяти рабочего
...
Изменения в rap 1.1.15                                          15.02.2012
    ...
    *) Исправление: вызов $r->flush() несколько раз подряд мог приводить к
       ошибкам в модуле rp_http_gzip_filter_module.
...
Изменения в rap 1.1.12                                          26.12.2011
    ...
    *) Исправление: в модуле rp_http_scgi_module.
...
Изменения в rap 1.1.9                                           28.11.2011
    ...
    *) Исправление: в модуле rp_http_flv_module.
       Спасибо Piotr Sikora.
...
Изменения в rap 1.1.8                                           14.11.2011
    ...
    *) Изменение: модуль rp_http_limit_zone_module переименован в
    ...
    *) Исправление: модуль rp_http_mp4_module выдавал неверную строку
...
Изменения в rap 1.1.6                                           17.10.2011
    ...
    *) Исправление: директивы модуля rp_http_rewrite_module, заданные на
    ...
    *) Исправление: модуль rp_http_mp4_module не поддерживал перемотку на
...
Изменения в rap 1.1.5                                           05.10.2011
    ...
    *) Исправление: в модуле rp_http_proxy_module при работе с бэкендами по
       HTTP/1.1.

    *) Исправление: закэшированные ответы с пустым телом возвращались
       некорректно; ошибка появилась в 0.8.31.

    *) Исправление: ответы с кодом 201 модуля rp_http_dav_module были
...
Изменения в rap 1.1.4                                           20.09.2011
    ...
    *) Добавление: модуль rp_http_upstream_keepalive.
    ...
    *) Исправление: модуль rp_http_mp4_module не поддерживал 64-битный
       MP4-атом co64.


Изменения в rap 1.1.3                                           14.09.2011

    *) Добавление: модуль rp_http_mp4_module.
...
Изменения в rap 1.0.3                                           25.05.2011
    ...
    *) Добавление: модули rp_http_geo_module и rp_http_geoip_module
...
Изменения в rap 0.9.0                                           29.11.2010
    ...
    *) Исправление: совместимость с модулем rp_http_eval_module; ошибка
       появилась в 0.8.42.
...
Изменения в rap 0.8.50                                          02.09.2010
    ...
    *) Добавление: директивы secure_link, secure_link_md5 и
       secure_link_expires модуля rp_http_secure_link_module.
...
Изменения в rap 0.8.48                                          03.08.2010
    ...
    *) Исправление: модуль rp_http_image_filter_module закрывал соединение,
...
Изменения в rap 0.8.45                                          13.07.2010
    ...
    *) Добавление: улучшения в модуле rp_http_xslt_filter.
...
Изменения в rap 0.8.42                                          21.06.2010
    ...
    *) Добавление: модуль rp_http_scgi_module.
...
Изменения в rap 0.8.40                                          07.06.2010
    ...
    *) Добавление: модуль rp_http_uwsgi_module.
       Спасибо Roberto De Ioris.
...
Изменения в rap 0.8.37                                          17.05.2010
    ...
    *) Добавление: модуль rp_http_split_clients_module.
...
Изменения в rap 0.8.36                                          22.04.2010
    ...
    *) Исправление: модуль rp_http_dav_module неправильно обрабатывал
...
Изменения в rap 0.8.35                                          01.04.2010
    ...
    *) Исправление: модуль rp_http_memcached_module мог выдавать ошибку
...
Изменения в rap 0.8.31                                          23.12.2009
    ...
    *) Добавление: модуль rp_http_image_filter_module теперь всегда удаляет
...
Изменения в rap 0.8.25                                          16.11.2009
    ...
    *) Добавление: модуль rp_http_degradation_module.
...
Изменения в rap 0.8.24                                          11.11.2009
    ...
    *) Исправление: rap всегда добавлял строку "Content-Encoding: gzip" в
       заголовок 304-ых ответов модуля rp_http_gzip_static_module.
...
Изменения в rap 0.8.20                                          14.10.2009
    ...
    *) Исправление: модуль rp_http_autoindex_module не показывал последний
...
Изменения в rap 0.8.6                                           20.07.2009
    ...
    *) Добавление: модуль rp_http_geoip_module.
...
Изменения в rap 0.8.5                                           13.07.2009
    ...
    *) Исправление: ответы модуля rp_http_perl_module не работали в
       подзапросах.

    *) Исправление: в модуле rp_http_limit_req_module.
       Спасибо Максиму Дунину.
...
Изменения в rap 0.8.1                                           08.06.2009
    ...
    *) Исправление: модуль rp_http_image_filter_module не понимал формат
       GIF87a.
...
Изменения в rap 0.7.58                                          18.05.2009
    ...
    *) Исправление: в модуле rp_http_autoindex_module в ссылках на имена
...
Изменения в rap 0.7.57                                          12.05.2009
    ...
    *) Исправление: при перенаправлении ошибок модуля
       rp_http_image_filter_module в именованный location в рабочем
...
Изменения в rap 0.7.56                                          11.05.2009
    ...
    *) Исправление: в модуле rp_http_image_filter_module.
...
Изменения в rap 0.7.55                                          06.05.2009
    ...
    *) Исправление: в сборке модуля rp_http_image_filter_module.
...
Изменения в rap 0.7.54                                          01.05.2009
    ...
    *) Добавление: модуль rp_http_image_filter_module.
...
Изменения в rap 0.7.52                                          20.04.2009
    ...
    *) Исправление: если rap был собран с модулем rp_http_perl_module и
...
Изменения в rap 0.7.40                                          09.03.2009
    ...
    *) Изменение: модуль rp_http_autoindex_module не показывал последний
...
Изменения в rap 0.7.31                                          19.01.2009
    ...
    *) Исправление: при отсутствии ответа rp_http_memcached_module
...
Изменения в rap 0.7.29                                          24.12.2008
    ...
    *) Исправление: в выделении памяти в модуле rp_http_gzip_filter_module
       под Cygwin.


Изменения в rap 0.7.28                                          22.12.2008

    *) Изменение: в выделении памяти в модуле rp_http_gzip_filter_module.
...
Изменения в rap 0.7.21                                          11.11.2008
    ...
    *) Изменения в модуле rp_http_limit_req_module.

    *) Добавление: поддержка EXSLT в модуле rp_http_xslt_module.
       Спасибо Денису Латыпову.
...
Изменения в rap 0.7.20                                          10.11.2008
    ...
    *) Изменения в модуле rp_http_gzip_filter_module.

    *) Добавление: модуль rp_http_limit_req_module.
    ...
    *) Исправление: модуль rp_http_secure_link_module не работал внутри
...
Изменения в rap 0.7.18                                          13.10.2008
    ...
    *) Добавление: модуль rp_http_secure_link_module.
...
Изменения в rap 0.7.17                                          15.09.2008
    ...
    *) Исправление: модуль rp_http_charset_module не понимал название
...
Изменения в rap 0.7.15                                          08.09.2008
    ...
    *) Добавление: модуль rp_http_random_index_module.
...
Изменения в rap 0.7.11                                          18.08.2008
    ...
    *) Изменение: теперь rp_http_charset_module по умолчанию не работает
       MIME-типом text/css.
...
Изменения в rap 0.7.10                                          13.08.2008
    ...
    *) Исправление: теперь модуль rp_http_realip_module устанавливает адрес
...
Изменения в rap 0.7.9                                           12.08.2008
    ...
    *) Изменение: теперь rp_http_charset_module по умолчанию работает со
    ...
    *) Добавление: модуль rp_cpp_test_module.

    *) Добавление: директива expires поддерживает суточное время.

    *) Добавление: улучшения и исправления в модуле rp_http_xslt_module.
...
Изменения в rap 0.7.8                                           04.08.2008
    ...
    *) Добавление: модуль rp_http_xslt_module.
...
Изменения в rap 0.7.6                                           07.07.2008
    ...
    *) Исправление: модуль rp_http_flv_module не поддерживал несколько
...
Изменения в rap 0.6.29                                          18.03.2008
    ...
    *) Добавление: модуль rp_google_perftools_module.

    *) Исправление: модуль rp_http_perl_module не собирался на 64-битных
...
Изменения в rap 0.6.25                                          08.01.2008
    ...
    *) Исправление: модуль rp_http_gzip_static_module не позволял работать
       модулю rp_http_dav_module; ошибка появилась в 0.6.23.
...
Изменения в rap 0.6.23                                          27.12.2007
    ...
    *) Добавление: модуль rp_http_gzip_static_module.
...
Изменения в rap 0.6.22                                          19.12.2007
    ...
    *) Изменение: теперь все методы модуля rp_http_perl_module возвращают
       значения, скопированные в память, выделенную perl'ом.

    *) Исправление: если rap был собран с модулем rp_http_perl_module,
    ...
    *) Исправление: в методы модуля rp_http_perl_module могли передаваться
...
Изменения в rap 0.6.18                                          27.11.2007
    ...
    *) Изменение: теперь модуль rp_http_userid_module в поле куки с номером
...
Изменения в rap 0.6.14                                          15.10.2007
    ...
    *) Исправление: при использовании переменных $date_local и $date_gmt вне
       модуля rp_http_ssi_filter_module в рабочем процессе происходил
       segmentation fault.
    ...
    *) Исправление: rp_http_memcached_module не устанавливал
...
Изменения в rap 0.6.7                                           15.08.2007
    ...
    *) Добавление: модуль rp_http_perl_module поддерживает метод
...
Изменения в rap 0.6.1                                           17.06.2007
    ...
    *) Исправление: значение perl'овой переменной $$ модуля
       rp_http_perl_module было равно номеру главного процесса.
...
Изменения в rap 0.5.23                                          04.06.2007
    ...
    *) Добавление: модуль rp_http_ssl_module поддерживает расширение TLS
...
Изменения в rap 0.5.20                                          07.05.2007
    ...
    *) Исправление: модуль rp_http_perl_module не собирался make в Solaris.
       Спасибо Андрею Нигматулину.
...
Изменения в rap 0.5.19                                          24.04.2007
    ...
    *) Изменение: метод $r->rflush в модуле rp_http_perl_module
...
Изменения в rap 0.5.18                                          19.04.2007
    ...
    *) Добавление: модуль rp_http_sub_filter_module.
...
Изменения в rap 0.5.13                                          19.02.2007
    ...
    *) Исправление: модуль rp_http_realip_module устанавливал мусор для
...
Изменения в rap 0.5.12                                          12.02.2007
    ...
    *) Исправление: rp_http_perl_module не собирался на Solaris.
...
Изменения в rap 0.5.9                                           25.01.2007
    ...
    *) Изменение: модуль rp_http_memcached_module теперь в качестве ключа
...
Изменения в rap 0.5.6                                           09.01.2007
    ...
    *) Изменение: теперь модуль rp_http_index_module игнорирует все методы,
       кроме GET, HEAD и POST.

    *) Добавление: модуль rp_http_limit_zone_module.

    *) Добавление: переменная $binary_remote_addr.

    *) Добавление: директивы ssl_session_cache модулей rp_http_ssl_module и
       rp_imap_ssl_module.
...
Изменения в rap 0.5.4                                           15.12.2006
    ...
    *) Исправление: модуль rp_http_dav_module требовал строку "Date" в
...
Изменения в rap 0.5.3                                           13.12.2006
    ...
    *) Добавление: модуль rp_http_perl_module поддерживает методы
...
Изменения в rap 0.5.1                                           11.12.2006
    ...
    *) Исправление: rp_http_auth_basic_module игнорировал пользователя,
...
Изменения в rap 0.4.14                                          27.11.2006
    ...
    *) Исправление: rp_http_perl_module не работал с перлом, собранным с
       поддержкой потоков; ошибка появилась в 0.3.38.

    *) Исправление: rp_http_perl_module не работал корректно, если перл
...
Изменения в rap 0.4.13                                          15.11.2006
    ...
    *) Исправление: для ответов модуля rp_http_autoindex_module не
...
Изменения в rap 0.4.10                                          23.10.2006
    ...
    *) Исправление: модуль rp_http_flv_module не поддерживал byte ranges
...
Изменения в rap 0.4.9                                           13.10.2006
    ...
    *) Добавление: модуль rp_http_perl_module теперь проверяет версию
       модуля rap.pm.
...
Изменения в rap 0.4.8                                           11.10.2006
    ...
    *) Исправление: модуль rp_http_flv_module добавлял FLV-заголовок для
       полных ответов.
...
Изменения в rap 0.4.7                                           10.10.2006
    ...
    *) Добавление: модуль rp_http_flv_module.
...
Изменения в rap 0.4.6                                           06.10.2006
    ...
    *) Исправление: после перенаправления ошибки с помощью директивы
       error_page любая директива модуля rp_http_rewrite_module возвращала
...
Изменения в rap 0.4.3                                           26.09.2006
    ...
    *) Добавление: модуль rp_http_browser_module.
...
Изменения в rap 0.4.0                                           30.08.2006
    ...
    *) Изменение: теперь тело запроса в модуле rp_http_perl_module не
       считывается заранее: нужно явно инициировать чтение с помощью метода
       $r->has_request_body.

    *) Добавление: модуль rp_http_perl_module поддерживает код возврата
       DECLINED.

    *) Добавление: модуль rp_http_dav_module поддерживает входящую строку
...
Изменения в rap 0.3.55                                          28.07.2006
    ...
    *) Исправление: метод $r->header_in("Cookie") модуля
       rp_http_perl_module теперь возвращает все строки "Cookie" в
       заголовке запроса.
...
Изменения в rap 0.3.52                                          03.07.2006
    ...
    *) Изменение: восстановлено поведение модуля rp_http_index_module для
    ...
    *) Исправление: модуль rp_http_charset_module записывал в лог ошибку
...
Изменения в rap 0.3.50                                          28.06.2006
    ...
    *) Добавление: модуль rp_http_charset_module поддерживает
...
Изменения в rap 0.3.48                                          29.05.2006
    ...
    *) Изменение: теперь модуль rp_http_charset_module работает для
    ...
    *) Исправление: модуль rp_http_perl_module не собирался, если перл был
...
Изменения в rap 0.3.40                                          19.04.2006
    ...
    *) Добавление: модуль rp_http_dav_module поддерживает метод MKCOL.
...
Изменения в rap 0.3.38                                          14.04.2006
    ...
    *) Добавление: модуль rp_http_dav_module.

    *) Изменение: оптимизация модуля rp_http_perl_module.
...
Изменения в rap 0.3.37                                          07.04.2006
    ...
    *) Исправление: в модуле rp_http_addition_filter_module.


Изменения в rap 0.3.36                                          05.04.2006

    *) Добавление: модуль rp_http_addition_filter_module.
    ...
    *) Добавление: модуль rp_http_ssi_module поддерживает команду elif.

    *) Исправление: строка "\/" в начале выражения команды if модуля
       rp_http_ssi_module воспринималась неверно.

    *) Исправление: в использовании регулярных выражениях в команде if
       модуля rp_http_ssi_module.
...
Изменения в rap 0.3.33                                          15.03.2006
    ...
    *) Исправление: rp_http_perl_module не работал со встроенным в
...
Изменения в rap 0.3.30                                          22.02.2006
    ...
    *) Исправление: модуль rp_http_perl_module не собирался без модуля
...
Изменения в rap 0.3.23                                          24.01.2006
    ...
    *) Исправление: модуль rp_http_perl_module неправильно собирался на
       Linux и Solaris.


Изменения в rap 0.3.22                                          17.01.2006

    *) Добавление: модуль rp_http_perl_module поддерживает методы $r->args
       и $r->unescape.

    *) Добавление: метод $r->query_string в модуле rp_http_perl_module
       упразднён.
...
Изменения в rap 0.3.21                                          16.01.2006
    ...
    *) Добавление: модуль rp_http_perl_module.
...
Изменения в rap 0.3.20                                          11.01.2006
    ...
    *) Исправление: модуль rp_http_memcached_module не поддерживал ключи в
       виде /uri?args.
...
Изменения в rap 0.3.18                                          26.12.2005
    ...
    *) Исправление: некоторые имена вида ".domain.tld" неверно
       обрабатывались модулем rp_http_map_module.
...
Изменения в rap 0.3.16                                          16.12.2005
    ...
    *) Добавление: модуль rp_http_map_module.
...
Изменения в rap 0.3.12                                          26.11.2005
    ...
    *) Безопасность: если rap был собран с модулем rp_http_realip_module,
       то при использовании директивы "satisfy_any on" директивы доступа и
       аутентификации не работали. Модуль rp_http_realip_module не
    ...
    *) Добавление: модуль rp_http_memcached_module.
...
Изменения в rap 0.3.10                                          15.11.2005
    ...
    *) Изменение: директива valid_referers и переменная $invalid_referer
       перенесены из модуля rp_http_rewrite_module в новый модуль
       rp_http_referer_module.
    ...
    *) Добавление: модуль rp_http_empty_gif_module.
...
Изменения в rap 0.3.8                                           09.11.2005
    ...
    *) Добавление: директива ssl_session_timeout модулей rp_http_ssl_module
       и rp_imap_ssl_module.

    *) Добавление: директива auth_http_header модуля
       rp_imap_auth_http_module.

    *) Добавление: директива add_header.

    *) Добавление: модуль rp_http_realip_module.
...
Изменения в rap 0.2.6                                           05.10.2005
    ...
    *) Исправление: если после изменения URI в блоке if для запроса не
       ...
       rp_http_rewrite_module выполнялись снова.

    *) Исправление: если директива set устанавливала переменную модуля
       rp_http_geo_module в какой-либо части конфигурации, то эта
...
Изменения в rap 0.2.5                                           04.10.2005
    ...
    *) Изменение: дублирующее значение переменной модуля rp_http_geo_module
       теперь выдаёт предупреждение и изменяет старое значение.

    *) Добавление: модуль rp_http_ssi_module поддерживает команду set.

    *) Добавление: модуль rp_http_ssi_module поддерживает параметр file в
       команде include.

    *) Добавление: модуль rp_http_ssi_module поддерживает подстановку
       значений переменных в выражениях команды if.


Изменения в rap 0.2.4                                           03.10.2005

    *) Добавление: модуль rp_http_ssi_module поддерживает выражения
...
Изменения в rap 0.2.2                                           30.09.2005
    ...
    *) Добавление: команда config errmsg в модуле rp_http_ssi_module.

    *) Изменение: переменные модуля rp_http_geo_module можно переопределять
       директивой set.

    *) Добавление: директивы ssl_protocols и ssl_prefer_server_ciphers
       модулей rp_http_ssl_module и rp_imap_ssl_module.

    *) Исправление: ошибка в модуле rp_http_autoindex_module при показе
       длинных имён файлов;

    *) Исправление: модуль rp_http_autoindex_module теперь не показывает
...
Изменения в rap 0.2.0                                           23.09.2005
    ...
    *) Изменение: модули rp_http_access_module и rp_http_auth_basic_module
...
Изменения в rap 0.1.45                                          08.09.2005
    ...
    *) Изменение: директива ssl_engine упразднена в модуле
       rp_http_ssl_module и перенесена на глобальный уровень.
...
Изменения в rap 0.1.44                                          06.09.2005
    ...
    *) Добавление: директива proxy_timeout модуля rp_imap_proxy_module.
...
Изменения в rap 0.1.42                                          23.08.2005
    ...
    *) Исправление: если URI запроса получался нулевой длины после обработки
       модулем rp_http_rewrite_module, то в модуле rp_http_proxy_module
...
Изменения в rap 0.1.39                                          14.07.2005
    ...
    *) Изменения в модуле rp_http_charset_module: директива default_charset
    ...
    *) Исправление: модули rp_http_proxy_module и rp_http_fastcgi_module
    ...
    *) Исправление: модуль rp_http_ssi_module не поддерживал относительные
    ...
    *) Исправление: некоторые директивы модулей rp_http_proxy_module и
       rp_http_fastcgi_module не наследовались с уровня server на уровень
       location; ошибка появилась в 0.1.29.

    *) Исправление: модуль rp_http_ssl_module не поддерживал цепочки
       сертификатов.
...
Изменения в rap 0.1.38                                          08.07.2005
    ...
    *) Исправление: модуль rp_http_autoindex_module не поддерживал длинные
...
Изменения в rap 0.1.36                                          15.06.2005
    ...
    *) Исправление: модуль rp_http_autoindex_module не поддерживал имена
       файлов в UTF-8.
...
Изменения в rap 0.1.29                                          12.05.2005
    ...
    *) Добавление: модуль rp_http_ssi_module поддерживает команду include
       virtual.

    *) Добавление: модуль rp_http_ssi_module поддерживает условную команду
       вида 'if expr="$NAME"' и команды else и endif. Допускается только
       один уровень вложенности.

    *) Добавление: модуль rp_http_ssi_module поддерживает две переменные
    ...
    *) Изменение: модуль rp_http_proxy_module полностью переписан.
    ...
    *) Исправление: модуль rp_http_auth_module не работал на Linux.
...
Изменения в rap 0.1.27                                          28.03.2005
    ...
    *) Исправление: rap не собирался на FreeBSD и Linux, если был указан
       параметр конфигурации --without-rp_http_auth_basic_module.
...
Изменения в rap 0.1.26                                          22.03.2005
    ...
    *) Добавление: модуль rp_http_auth_basic_module и директивы auth_basic
...
Изменения в rap 0.1.25                                          19.03.2005
    ...
    *) Исправление: если модуль rp_http_index_module делал внутреннее
       перенаправление запроса в модули rp_http_proxy_module или
       rp_http_fastcgi_module, то файл индекса не закрывался после
       обслуживания запроса.

    *) Добавление: директива proxy_pass может использоваться в location,
       заданных регулярным выражением.

    *) Добавление: модуль rp_http_rewrite_filter_module поддерживает
...
Изменения в rap 0.1.24                                          04.03.2005
    ...
    *) Добавление: модуль rp_http_ssi_filter_module поддерживает переменные
       QUERY_STRING и DOCUMENT_URI.

    *) Исправление: модуль rp_http_autoindex_module мог выдавать ответ 404
       на существующий каталог, если этот каталог был указан как alias.

    *) Исправление: модуль rp_http_ssi_filter_module неправильно работал
       при больших ответах.
...
Изменения в rap 0.1.23                                          01.03.2005
    ...
    *) Добавление: модуль rp_http_ssi_filter_module и директивы ssi,
    ...
    *) Исправление: модуль rp_http_autoindex_module теперь показывает
...
Изменения в rap 0.1.22                                          22.02.2005
    ...
    *) Исправление: модуль rp_http_stub_status_module показывал неверную
...
Изменения в rap 0.1.18                                          09.02.2005
    ...
    *) Исправление: строки для модуля rp_http_geo_module без символа ";" во
       включённом файле игнорировались.

    *) Добавление: модуль rp_http_stub_status_module.
...
Изменения в rap 0.1.17                                          03.02.2005
    ...
    *) Изменение: модуль rp_http_rewrite_module полностью переписан. Теперь
    ...
    *) Добавление: модуль rp_http_geo_module.
...
Изменения в rap 0.1.16                                          25.01.2005
    ...
    *) Исправление: ошибки в модуле rp_http_fastcgi_module вызывали
       segmentation fault.
...
Изменения в rap 0.1.15                                          19.01.2005
    ...
    *) Исправление: для использования регулярных выражений в location нужно
       было собирать rap вместе с rp_http_rewrite_module.
...
Изменения в rap 0.1.14                                          18.01.2005
    ...
    *) Добавление: модуль rp_http_fastcgi_module и директивы fastcgi_pass,
...
Изменения в rap 0.1.11                                          02.12.2004
    ...
    *) Изменение: rp_http_auto_index_module теперь выдаёт размер файлов в
       байтах.

    *) Исправление: rp_http_auto_index_module возвращал ошибку 500, если в
...
Изменения в rap 0.1.5                                           11.11.2004
    ...
    *) Исправление: в списке файлов, выдаваемом модулем
       rp_http_autoindex_module, не перекодировались пробелы, кавычки и
       знаки процента.
...
Изменения в rap 0.1.4                                           26.10.2004
    ...
    *) Исправление: ошибка в модуле rp_http_autoindex_module.


Изменения в rap 0.1.3                                           25.10.2004

    *) Добавление: модуль rp_http_autoindex_module и директива autoindex.
...
Изменения в rap 0.1.1                                           11.10.2004
    ...
    *) Исправление: ошибка в модуле rp_http_chunked_module, приводившая к
       зацикливанию.
